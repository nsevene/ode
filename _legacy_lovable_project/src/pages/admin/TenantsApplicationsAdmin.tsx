                ...
                <div className="space-y-2">
                  ...
                  {app.expected_revenue && (
                    <div className="flex items-center gap-2">
                      <DollarSign className="h-4 w-4 text-muted-foreground" />
                      <span className="text-sm">
                        Ожидаемый доход: {app.expected_revenue}
                      </span>
                    </div>
                  )}
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          <div>
                            ...
                            <div className="space-y-1 text-sm">
                              ...
                              <p>
                                <strong>Телефон:</strong> {selectedApp.phone}
                              </p>
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="space-y-1 text-sm">
                              ...
                              {selectedApp.cuisine_type && (
                                <p>
                                  <strong>Тип кухни:</strong>{' '}
                                  {selectedApp.cuisine_type}
                                </p>
                              )}
                              <p>
                                <strong>Лицензия на питание:</strong>{' '}
                                {selectedApp.has_food_license ? 'Да' : 'Нет'}
                              </p>
                            </div>
                          </div>
                        </div>
