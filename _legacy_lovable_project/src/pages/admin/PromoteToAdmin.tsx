    ...
    try {
      ...
      if (userError || !userData?.user) {
        setResult({
          success: false,
          message:
            'Пользователь с таким email не найден в системе. Проверьте email и попробуйте снова.',
        });
        setLoading(false);
        return;
      }
      ...
      setResult({
        success: false,
        message:
          'Произошла ошибка при назначении администратора. Попробуйте снова.',
      });
    }
          ...
          <CardContent>
            <form onSubmit={handlePromoteToAdmin} className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  Введите email пользователя, которого хотите назначить
                  администратором
                </p>
              </div>
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg">
              ...
              <ol className="text-xs text-blue-800 space-y-1">
                <li>
                  1. Введите email пользователя для назначения администратором
                </li>
