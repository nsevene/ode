      ...
      <div className="mx-auto max-w-4xl p-6">
        <header className="mb-8">
          ...
          <p className="text-muted-foreground">
            Comprehensive marketing support and budget allocation for all
            tenants
          </p>
        </header>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-orange-800">
                Detailed marketing budget information will be finalized after
                vendor negotiations are complete. This framework provides the
                structure for our marketing support program.
              </p>
            </div>
          </div>
        </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="pt-3 border-t">
                <p className="text-xs text-muted-foreground">
                  Budget percentages may vary based on tenant category and
                  seasonal campaigns
                </p>
              </div>
            </CardContent>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                {
                  month: 'Jan-Feb',
                  campaign: 'New Year, New Flavors',
                  focus: 'Health-conscious dining',
                },
                {
                  month: 'Mar-Apr',
                  campaign: 'Spring Awakening',
                  focus: 'Fresh ingredients, seasonal menus',
                },
                {
                  month: 'May-Jun',
                  campaign: 'Taste of Ubud',
                  focus: 'Local culture and flavors',
                },
                {
                  month: 'Jul-Aug',
                  campaign: 'Summer Nights',
                  focus: 'ODE by Night events',
                },
                {
                  month: 'Sep-Oct',
                  campaign: 'Harvest Festival',
                  focus: 'Farm-to-table experiences',
                },
                {
                  month: 'Nov-Dec',
                  campaign: 'Holiday Celebrations',
                  focus: 'Festive menus and events',
                },
              ].map((item, index) => (
                <div
                  key={index}
        ...
        <div className="text-center mt-8">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Contact our team to discuss custom marketing solutions for your
            concept
          </p>
        </div>
      </div>
