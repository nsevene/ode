      ...
      <div className="container mx-auto px-4 pt-24 pb-12">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-charcoal/70 max-w-3xl mx-auto">
            Explore available spaces and find the perfect location for your
            culinary concept
          </p>
        </div>
                    ...
                    <div className="absolute inset-0 bg-white border-2 border-charcoal/20 rounded-lg">
                      ...
                      <div className="absolute inset-0 opacity-20">
                        {Array.from({ length: 10 }).map((_, i) => (
                          <div
                            key={i}
                            className="absolute border-l border-charcoal/10"
                            style={{ left: `${i * 10}%` }}
                          />
                        ))}
                        {Array.from({ length: 8 }).map((_, i) => (
                          <div
                            key={i}
                            className="absolute border-t border-charcoal/10"
                            style={{ top: `${i * 12.5}%` }}
                          />
                        ))}
                      </div>
                      ...
                      {filteredSpaces.map((space) => (
                        ...
                        >
                          <div
                            className={`w-full h-full rounded-lg border-2 border-white ${getStatusColor(space.status)} opacity-80 hover:opacity-100`}
                          >
                            ...
                            <div className="absolute top-1 right-1">
                              <div
                                className={`w-3 h-3 rounded-full ${getStatusColor(space.status)}`}
                              />
                            </div>
                          </div>
                        </div>
              ...
              <Card>
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-sm text-charcoal/60">
                    Click on any space in the floor plan to view details and
                    availability
                  </p>
                </CardContent>
              </Card>
