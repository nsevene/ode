  ...
  const benefits = [
    {
      ...
      description:
        'Located in the heart of Ubud, Bali - the cultural and spiritual center of the island',
    ...
    },
    {
      ...
      description:
        'Strategic location between Central Market and Monkey Forest Road',
    ...
    },
    {
      ...
      description:
        'Curated culinary experience with 12 diverse kitchen corners',
    ...
    },
    {
      ...
      title: 'Full Support',
      description:
        'Complete business support including marketing, operations, and management',
      ...
      <div className="container mx-auto px-4 pt-24 pb-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-charcoal/70 max-w-3xl mx-auto mb-8">
            Join Bali's premier culinary destination and be part of a unique
            food hall experience that celebrates authentic flavors from around
            the world.
          </p>
        ...
        <section className="bg-gradient-light rounded-2xl p-8 text-center">
          ...
          <p className="text-charcoal/70 mb-6 max-w-2xl mx-auto">
            Start your culinary journey with us and be part of Bali's most
            innovative food hall experience.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button variant="outline" size="lg" asChild>
              <a href="/tenants/floor-plan">View Floor Plan</a>
            </Button>
          </div>
        </section>
      </div>
