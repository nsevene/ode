    ...
    <section className="mx-auto max-w-3xl space-y-6 py-8">
      <header>
        ...
        <p className="text-sm text-muted-foreground">
          Долгосрочные резиденты — базовая модель. Pop-Up — отдельный формат.
        </p>
      </header>
      ...
      <div className="rounded-xl border p-4">
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>
            Все корнеры имеют подключения: вода, канализация,
            вентиляция/вытяжка, 7–16 кВт.
          </li>
      ...
      <div className="pt-2 flex gap-3">
        ...
        <a
          className="inline-flex items-center rounded-lg border px-4 py-2 hover:bg-muted"
          href="/storage/rate-card.pdf"
          target="_blank"
          rel="noreferrer"
        >
          Скачать Rate Card (PDF)
        </a>
      </div>
    </section>
  );
