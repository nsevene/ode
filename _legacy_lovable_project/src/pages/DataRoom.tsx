...
const DataRoom: React.FC = () => {
  ...
  const accessibleSections = Object.entries(sections).filter(
    ([_, sectionData]) => sectionData.accessible.includes(userRole || '')
  );
            ...
            <Card>
              <CardContent className="pt-8">
                ...
                <p className="text-muted-foreground">
                  The Data Room is only accessible to investors and internal
                  team members. Please contact your administrator if you believe
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Secure access to important documents, financial information, and
              legal materials.
            </p>
                  ...
                  <CardContent>
                    {loading ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-muted-foreground">
                          Documents will appear here once they are uploaded by
                          the internal team.
                        </p>
                      </div>
                    )}
          ...
          <Card className="mt-8">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                All documents in this data room are confidential and
                proprietary. Access is logged and monitored. By downloading or
                viewing these documents, you agree to maintain their
                confidentiality and use them solely for legitimate business
                purposes related to your involvement with ODE Food Hall.
              </p>
            </CardContent>
          </Card>
        </div>
