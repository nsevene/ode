...
export const EnhancedBookingFlow = ({
  ...
  const selectedExperience = EXPERIENCE_TYPES.find(
    (exp) => exp.id === bookingData.experienceType
  );
              ...
              <div className="grid grid-cols-3 md:grid-cols-4 gap-2">
                {TIME_SLOTS.map((time) => (
                  <Button
                    key={time}
                    variant={
                      bookingData.timeSlot === time ? 'default' : 'outline'
                    }
          ...
          <div className="space-y-6">
                ...
                {Array.from({ length: maxGuests }, (_, i) => i + 1).map(
                  (num) => (
                    <Button
                      key={num}
                      variant={
                        bookingData.guestCount === num ? 'default' : 'outline'
                      }
            ...
            <div className="space-y-3">
              ...
              <div className="grid gap-3">
                {EXPERIENCE_TYPES.filter((exp) =>
                  availableExperiences.includes(exp.id)
                ).map((exp) => (
                  <Card
                    key={exp.id}
            ...
            <div className="space-y-3">
              <Label htmlFor="table-preference">
                Предпочтения по столу (опционально)
              </Label>
              <Select
                value={bookingData.tablePreference}
                onValueChange={(value) =>
                  updateBookingData('tablePreference', value)
                }
              >
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  updateBookingData('dietaryRestrictions', e.target.value)
                }
          ...
          <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      ...
                      {bookingData.guestCount === 1 ? 'гость' : 'гостя'}
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                ...
                {selectedExperience && selectedExperience.price > 0 && (
                  <div className="flex justify-between items-center text-lg font-semibold">
                    ...
                    <span className="text-primary">
                      {(
                        selectedExperience.price * bookingData.guestCount
                      ).toLocaleString()}{' '}
                      ₽
                    </span>
                  </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                <p>
                  <strong>Имя:</strong> {bookingData.guestName}
                </p>
                <p>
                ...
                {bookingData.guestPhone && (
                  <p>
                    <strong>Телефон:</strong> {bookingData.guestPhone}
                  </p>
                )}
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              ...
              <p className="text-green-700 text-sm mt-1">
                Мы гарантируем высокое качество обслуживания и соблюдение всех
                санитарных норм.
              </p>
            </div>
          </div>
      ...
      <CardHeader className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Badge variant="outline">
            {currentStep} из {BOOKING_STEPS.length}
          </Badge>
        </div>
