...
export const QuickBooking = ({
  ...
  const totalPrice = selectedExperience
    ? selectedExperience.price * form.watch('guestCount')
    : 0;
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              {EXPERIENCE_OPTIONS.map((experience) => (
                <Card
                  ...
                  className={cn(
                    ...
                    form.watch('experienceType') === experience.id &&
                      'ring-2 ring-primary'
                  )}
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                form.setValue('guestCount', parseInt(value))
              }
            >
              <SelectTrigger>
              ...
              <SelectContent>
                {[1, 2, 3, 4, 5, 6, 7, 8].map((count) => (
                  <SelectItem key={count} value={count.toString()}>
                    {count}{' '}
                    {count === 1 ? 'гость' : count < 5 ? 'гостя' : 'гостей'}
                  </SelectItem>
                ))}
              </SelectContent>
            </Select>
