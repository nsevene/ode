  ...
  const tutorialSteps: TutorialStep[] = [
    {
      ...
      description:
        'Откройте для себя захватывающий мир вкусовых приключений через интерактивные квесты и достижения.',
    ...
    },
    {
      ...
      description:
        'Каждый сектор предлагает уникальные вкусовые испытания и интерактивные элементы.',
    ...
    },
    {
      ...
      description:
        'Следите за своими достижениями, уровнем и позицией в таблице лидеров.',
    ...
    },
    {
      ...
      description:
        'Разблокируйте уникальные награды и значки за выполнение специальных заданий.',
    ...
    },
    {
      ...
      description:
        'Рассказывайте о своих достижениях в социальных сетях и приглашайте друзей.',
    ...
    },
    {
      ...
      description:
        'Сканируйте NFC-метки в секторах для получения дополнительных очков и контента.',
