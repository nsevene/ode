...
const InteractiveSectorCards = ({
  sectors,
  onSectorClick,
}: InteractiveSectorCardsProps) => {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      {sectors.map((sector) => (
        ...
        >
          ...
          <div
            className={`absolute inset-0 bg-gradient-to-t from-transparent via-transparent to-white/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none`}
          />
        </Card>
      ))}
    </div>
