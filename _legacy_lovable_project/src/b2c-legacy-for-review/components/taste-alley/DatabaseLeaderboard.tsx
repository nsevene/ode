            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  ...
                  <div>
                    <div className="font-semibold text-emerald-600">
                      {currentUserEntry.completed_sectors}
                    </div>
                    <div className="text-muted-foreground">Sectors</div>
                  </div>
                  <div>
                    <div className="font-semibold text-emerald-600">
                      {currentUserEntry.fastest_time
                        ? `${currentUserEntry.fastest_time}min`
                        : 'N/A'}
                    </div>
              ...
              leaderboard.slice(0, 10).map((entry) => (
                ...
                >
                  {entry.current_rank <= 3 && (
                    <div
                      className={`absolute top-0 left-0 w-full h-1 bg-gradient-to-r ${getRankColor(entry.current_rank)}`}
                    />
                  )}
