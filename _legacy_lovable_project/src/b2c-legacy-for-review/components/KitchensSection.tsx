...
const KitchensSection = () => {
  const kitchenCorners = [
    ...
    },
    {
      ...
      area: '18.2m²',
      image:
        'https://images.unsplash.com/photo-1455619452474-d2be8b1e70cd?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80',
    },
    {
      emoji: '🔥',
      name: 'Smoke BBQ',
    ...
    },
    {
      ...
      area: '14.3m²',
      image:
        'https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80',
    },
    {
      emoji: '🥖',
      name: 'Bread Corner',
    ...
    },
    {
      ...
      area: '11.4m²',
      image:
        'https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80',
    },
    {
      emoji: '🥗',
      name: 'Salad Bar',
  ...
  return (
    <section
      id="food-corners"
      className="py-16 bg-gradient-to-b from-background via-muted/5 to-background"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            15 unique gastronomic spaces on the 1st floor. From classics to
            experiments — everyone will find their taste.
          </p>
        </header>
