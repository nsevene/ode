...
const GamificationTasteCompass = () => {
    ...
    const mockEvents: SeasonalEvent[] = [
      ...
      },
      {
        ...
        rewards: [
          'Весенний аватар',
          'Бонусные очки',
          'Ранний доступ к новым секторам',
        ],
        progress: 0,
        maxProgress: 100,
      },
  ...
  const activateMultiplier = (multiplierId: string) => {
    setMultipliers((prev) =>
      prev.map((mult) =>
        mult.type === multiplierId ? { ...mult, isActive: true } : mult
      )
    );
        ...
        <TabsContent value="events" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {seasonalEvents.map((event) => (
              <Card
                key={event.id}
                className={event.isActive ? 'ring-2 ring-primary' : ''}
              >
                <CardHeader>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Progress
                      value={(event.progress / event.maxProgress) * 100}
                      className="h-2"
                    />
                  </div>
                ...
                >
                  ...
                  <div className="text-right">
                    <div className="flex items-center gap-2">
                      <Badge variant="outline">+{quest.reward} очков</Badge>
                      {quest.isCompleted ? (
              ...
              {specialRewards.map((reward) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant="outline">+{reward.points} очков</Badge>
                    {reward.isUnlocked ? (
                      <Badge className="bg-green-100 text-green-800">
                        Разблокировано
                      </Badge>
            ...
            <CardContent className="space-y-4">
              {multipliers.map((multiplier) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium">
                        x{multiplier.value} {multiplier.description}
                      </p>
                      <p className="text-sm text-muted-foreground">
                  ...
                  <div className="flex items-center gap-2">
                    <Badge
                      variant={multiplier.isActive ? 'default' : 'outline'}
                    >
