      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Ready to embark on a culinary journey? Reserve your spot at ODE Food
            Hall and discover the taste compass.
          </p>
        </header>
        ...
        <Card className="shadow-xl border-primary/10">
          <CardHeader className="text-center pb-6">
            ...
            <p className="text-muted-foreground">
              Fill out the form below and we'll confirm your reservation within
              24 hours
            </p>
          </CardHeader>
          <CardContent>
        ...
        <div className="mt-12 text-center">
          <div className="bg-gradient-to-r from-primary/5 to-secondary/5 rounded-xl p-6 border border-primary/10">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              ...
              Be among the first to experience the Taste Compass journey at ODE
              Food Hall.
            </p>
          </div>
        </div>
