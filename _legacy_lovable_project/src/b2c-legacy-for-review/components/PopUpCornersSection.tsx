...
const PopUpCornersSection = () => {
  const corners = [
    ...
    },
    {
      ...
      emoji: '🌱',
      specialty: 'Balinese Plant-Based',
      rating: '★★★★☆',
      status: 'Open',
    },
    {
      name: 'INDIAN SPICE LAB',
      emoji: '🌶️',
      specialty: '7-Spice Curry',
      rating: '★★★★★',
      status: 'Open',
    },
    {
  ...
  return (
    <section className="py-20 px-5 text-center font-system">
      <h2 className="text-4xl mb-5 text-burgundy-primary">
        POP-UP GASTRO STAGE
      </h2>
      <p className="text-xl max-w-4xl mx-auto mb-10">
        12 rotating pop-up kitchens by chefs from Tokyo, Seoul, Bangkok, and
        Mumbai
      </p>
        ...
        {corners.map((corner, index) => (
          ...
          >
            ...
            <p className="my-1 text-lg">
              {corner.emoji} {corner.specialty}
            </p>
            <p className="my-1 text-lg">{corner.rating}</p>
            <p className="my-1 text-lg">
              <strong>{corner.status}</strong>
            </p>
          </div>
        ))}
      </div>
