  ...
  const [tours, setTours] = useState<GastroTour[]>([
    {
      ...
      description:
        'Научитесь готовить настоящую итальянскую пасту от шеф-повара из Dolce Italia. Изучите секреты приготовления идеального теста и соусов.',
      ...
      itinerary: [
        {
          time: '18:00',
          activity: 'Приветствие и знакомство',
          description: 'Знакомство с участниками и шеф-поваром',
        },
        {
          time: '18:15',
          activity: 'Теория пасты',
          description: 'Изучение основ приготовления итальянской пасты',
        },
        {
          time: '18:30',
          activity: 'Практика',
          description: 'Приготовление теста и формирование пасты',
        },
        {
          time: '19:30',
          activity: 'Соусы',
          description: 'Приготовление классических итальянских соусов',
        },
        {
          time: '20:00',
          activity: 'Дегустация',
          description: 'Дегустация приготовленных блюд с вином',
        },
      ],
      reviews: [
        {
          ...
          rating: 5,
          comment:
            'Невероятный мастер-класс! Научилась готовить пасту как в Италии. Marco - потрясающий преподаватель!',
          date: '2024-01-15',
        },
      ],
      isBookmarked: false,
    ...
    },
    {
      ...
      description:
        'Погрузитесь в мир вин и сыров с сомелье. Изучите основы виноделия и правильного сочетания вин с сырами.',
      ...
      requirements: ['Возраст от 18 лет', 'Любовь к вину и сыру'],
      highlights: [
      ...
      itinerary: [
        {
          time: '19:00',
          activity: 'Встреча',
          description: 'Знакомство с участниками и сомелье',
        },
        {
          time: '19:15',
          activity: 'Теория вин',
          description: 'Основы виноделия и классификация вин',
        },
        {
          time: '19:30',
          activity: 'Дегустация',
          description: 'Дегустация 5 видов вин с сырами',
        },
        {
          time: '20:15',
          activity: 'Обсуждение',
          description: 'Обсуждение впечатлений и вопросов',
        },
      ],
      reviews: [
        {
          ...
          rating: 5,
          comment:
            'Отличная дегустация! Узнал много нового о винах. Elena очень профессионально все объяснила.',
          date: '2024-01-10',
        },
      ],
      isBookmarked: true,
    ...
    <div className="max-w-7xl mx-auto space-y-6 p-4">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground">
          Уникальные кулинарные опыты, дегустации и мастер-классы от лучших
          шеф-поваров
        </p>
      </div>
          ...
          <Card key={tour.id} className="relative overflow-hidden">
            ...
            <CardHeader>
              <div className="flex items-start justify-between">
                ...
                >
                  <Heart
                    className={`h-4 w-4 ${tour.isBookmarked ? 'fill-red-500 text-red-500' : ''}`}
                  />
                </Button>
              </div>
            </CardHeader>
