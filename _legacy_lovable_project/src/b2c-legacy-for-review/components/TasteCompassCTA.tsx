...
const TasteCompassCTA = () => {
  ...
  return (
    <section
      id="taste-compass-cta"
      className="py-20 px-5 bg-gradient-to-br from-burgundy-primary via-charcoal to-burgundy-light"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center text-cream-light mb-12 animate-fade-in">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-8 opacity-90">
            Сканируйте NFC-стикеры в зонах, собирайте штампы и открывайте новые
            вкусы Бали
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {features.map((feature, index) => (
            <Card
              key={feature.title}
              className="bg-white/10 border-white/20 backdrop-blur-sm hover-scale animate-fade-in"
