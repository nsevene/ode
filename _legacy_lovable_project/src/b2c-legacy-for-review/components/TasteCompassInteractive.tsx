    ...
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Click on sectors to explore different flavor profiles and unlock
        ...
        <Card className="border-primary bg-gradient-to-r from-primary/10 to-secondary/10">
          <CardContent className="pt-6 text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              You've explored all flavor profiles. You've unlocked exclusive
              access to our Chef's Table experience.
            </p>
