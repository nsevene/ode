...
const blogPosts = [
  {
    ...
    excerpt:
      'Get ready for a unique gastronomic experience in the heart of Ubud',
    content:
      'We are excited to announce the opening of ODE Food Hall - an innovative space...',
    author: 'ODE Team',
    publishDate: '2024-11-15',
    category: 'News',
    image: '/src/assets/hero-food-hall.jpg',
    seoKeywords:
      'ODE Food Hall opening, new restaurant Ubud, gastronomic complex Bali',
  },
  {
    ...
    content:
      "Chef's Table at ODE Food Hall is not just dinner, it's a theatrical performance...",
    author: 'Chef Andrew',
  ...
  },
  {
    ...
    content:
      'Taste Compass is a unique system that allows you to explore culinary traditions...',
