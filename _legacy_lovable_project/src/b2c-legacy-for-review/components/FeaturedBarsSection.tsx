  ...
  const bars = [
    {
      ...
      hours: '12:00 - 01:00',
      description:
        'Artisan cocktails using local ingredients and premium spirits. Happy hour daily 5-7 PM.',
      highlights: [
        'Signature cocktails',
    ...
    },
    {
      ...
      hours: '16:00 - 24:00',
      description:
        'Curated selection of local and international wines. Perfect for intimate gatherings.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {bars.map((bar, index) => (
            <Card
              key={index}
              className="group hover:shadow-tropical transition-all duration-500 overflow-hidden"
            >
