...
const BreakfastForVillas = () => {
  ...
  const handleWhatsApp = () => {
    const message = encodeURIComponent(
      "Hi! I'd like to learn more about the Breakfast for Villas partnership program."
    );
  ...
  const howItWorks = [
    {
      ...
      title: 'Setup QR Code',
      description:
        "We provide you with a unique QR code for your villa's welcome book or reception area",
    },
    {
      step: 2,
      title: 'Guest Orders',
      description:
        'Your guests scan the code and order breakfast directly from our curated menu',
    },
    {
      step: 3,
      title: 'We Deliver',
      description:
        'Professional delivery or pick-up service ensures fresh, hot breakfast arrives on time',
    },
    {
      step: 4,
      title: 'You Earn',
      description:
        'Receive 10% commission on every confirmed breakfast order from your guests',
    },
  ];
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-gradient-primary p-6 rounded-2xl mb-8 text-pure-white">
              ...
              <p className="text-lg opacity-90">
                Partner with ODE Food Hall to offer gourmet breakfast
                experiences. We handle everything - you earn 10% commission on
                every order.
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {benefits.map((benefit, index) => (
                <Card
                  key={index}
                  className="border-sage-blue/20 hover:shadow-lg transition-shadow"
                >
                ...
                >
                  <CardContent className="p-6 text-center">
                    <div className="w-16 h-16 bg-sage-blue/10 rounded-full flex items-center justify-center mx-auto mb-4">
                      {index === 0 && (
                        <MapPin className="h-8 w-8 text-sage-blue" />
                      )}
                      {index === 1 && (
                        <Users className="h-8 w-8 text-sage-blue" />
                      )}
                      {index === 2 && (
                        <Utensils className="h-8 w-8 text-sage-blue" />
                      )}
                    </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {howItWorks.map((item, index) => (
                <Card
                  key={index}
                  className={`border-2 hover:shadow-xl transition-all transform hover:-translate-y-2 ${
                    index === 3
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-blue-700 font-medium">
                        Direct guests to us for breakfast — via QR, link, or
                        reception
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-blue-600 flex-shrink-0 mt-0.5" />
                      <span className="text-blue-700 font-medium">
                        Guests arrange transport through the hotel as convenient
                        for you
                      </span>
                    </li>
                  </ul>
              ...
              <Card className="border-2 border-emerald-200 bg-gradient-to-br from-emerald-50 to-teal-50 hover:shadow-xl transition-all">
                <CardContent className="p-8">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="font-bold text-emerald-700 text-xl">
                      Our Role:
                    </h3>
                  </div>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-emerald-700 font-medium">
                        Process orders, serve guests, and track the source
                      </span>
                    </li>
                    <li className="flex items-start gap-3 p-3 bg-gradient-to-r from-emerald-100 to-teal-100 rounded-lg border border-emerald-200">
                      ...
                      <span className="text-emerald-800 font-bold text-lg">
                        You receive 10% from every confirmed order! 💰
                      </span>
                    </li>
                  </ul>
                </CardContent>
