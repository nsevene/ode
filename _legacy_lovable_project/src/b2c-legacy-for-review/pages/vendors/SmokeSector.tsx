...
const SmokeSector = () => {
  ...
  const menuItems = [
    {
      ...
      description:
        'Классическая пицца Маргарита, приготовленная в дровяной печи при 450°C',
      price: 24,
    ...
    },
    {
      ...
      name: 'Smoked Brisket',
      description:
        'Говяжья грудинка холодного копчения 12 часов с BBQ соусом и маринованными овощами',
      price: 32,
    ...
    },
    {
      ...
      description:
        'Осьминог на открытом огне с травами, оливковым маслом и лимоном',
      price: 28,
    ...
    },
    {
      ...
      description:
        'Авторская пицца с копченым лососем, каперсами и сливочным сыром',
      price: 26,
    ...
    },
    {
      ...
      description:
        'Микс овощей, обжаренных на открытом огне с ароматными травами',
      price: 18,
  ...
  const seoData = {
    ...
    description:
      'Откройте древний огонь приготовления в секторе SMOKE. Неаполитанская пицца, BBQ, копченые деликатесы и блюда на открытом огне.',
    keywords:
      'огненная кухня, копчение, неаполитанская пицца, BBQ, дровяная печь, копченые блюда, Убуд',
    image: '/lovable-uploads/72f429cb-e3f6-44d1-a685-dd4002161507.png',
  };
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 h-full flex items-center">
          <div>
            ...
            <p className="text-xl text-white/90 max-w-2xl mb-6">
              Древний огонь приготовления, объединяющий традиции разных
              континентов
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <p className="text-muted-foreground text-lg leading-relaxed mb-4">
                  Сектор SMOKE — это храм огненной кулинарии, где древние
                  техники приготовления на открытом огне встречаются с
                  современными технологиями копчения.
                </p>
                <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                  Наша дровяная печь разогревается до 450°C для идеальной
                  неаполитанской пиццы, а коптильня работает круглосуточно для
                  создания невероятных вкусов.
                </p>
