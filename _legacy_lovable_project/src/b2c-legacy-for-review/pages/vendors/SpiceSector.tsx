...
const SpiceSector = () => {
  ...
  const menuItems = [
    {
      ...
      description:
        'Нежная курица в сливочно-томатном соусе с ароматными индийскими специями',
      price: 24,
    ...
    },
    {
      ...
      description:
        'Традиционное тайское зеленое карри с кокосовым молоком и свежими травами',
      price: 22,
    ...
    },
    {
      ...
      description:
        'Ароматный тажин с бараниной, сухофруктами и смесью марокканских специй',
      price: 28,
    ...
    },
    {
      ...
      description:
        'Дегустационный набор из 5 блюд разных кухонь Великого шелкового пути',
      price: 32,
  ...
  const seoData = {
    title:
      '🌶️ SPICE Sector - Путешествие по Великому шелковому пути | ODE Food Hall',
    description:
      'Исследуйте экзотические специи и пряности в секторе SPICE. Индийские карри, тайские пасты, марокканские тажины и блюда Великого шелкового пути.',
    keywords:
      'специи, пряности, острая еда, индийская кухня, тайская кухня, марокканская кухня, карри, шелковый путь, Убуд',
    image: '/lovable-uploads/54e09b7b-cb56-4ad2-beff-b051ddc7a068.png',
  };
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <p className="text-muted-foreground text-lg leading-relaxed mb-4">
                  Сектор SPICE — это кулинарное путешествие по Великому
                  шелковому пути, где каждое блюдо рассказывает историю торговых
                  караванов и культурного обмена.
                </p>
                <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                  Мы собрали самые яркие вкусы Азии, Африки и Ближнего Востока,
                  используя аутентичные специи и традиционные техники
                  приготовления.
                </p>
