...
const WineStaircase = () => {
  ...
  const features = [
    {
      ...
      description:
        'На каждом пролёте — полка с бутылками двух терруаров (например, «Сицилия vs Атакама»). Поднимаешься — сравниваешь стили, чувствуешь разницу климата и почв.',
    },
    {
      icon: <MapPin className="h-8 w-8 text-gold-accent" />,
      title: 'Цена себестоимости',
      description:
        'Цена — себестоимость бутылки + небольшой corkage-fee за сервис сомелье. Честное ценообразование для истинных ценителей вина.',
    },
    {
      icon: <Users className="h-8 w-8 text-gold-accent" />,
      title: 'Приватные дегустации',
      description:
        'Захотелось приват? Забронируй целый марш и собери вертикальную дегустацию от молодого Sauvignon до выдержанного Sauternes.',
    },
    {
      icon: <Calendar className="h-8 w-8 text-gold-accent" />,
      title: 'Винтажные коллекции',
      description:
        'Специальные тематические вечера с редкими винтажами и авторскими парингами от наших сомелье.',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section
        className={`relative ${isMobile ? 'min-h-screen pt-20 pb-20' : 'h-screen'} flex items-center justify-center overflow-hidden`}
      >
        ...
        <div
          className={`relative z-10 text-center text-white max-w-4xl mx-auto px-4 ${isMobile ? 'pb-16' : ''}`}
        >
          <h1
            className={`${isMobile ? 'text-3xl' : 'text-5xl md:text-7xl'} font-bold mb-4 md:mb-6 leading-tight`}
          >
            Wine Staircase
          </h1>
          <div className="mb-6">
          ...
          <p
            className={`${isMobile ? 'text-lg' : 'text-2xl md:text-3xl'} mb-6 md:mb-8 font-light`}
          >
            винная лестница открытий
          </p>
          <p
            className={`${isMobile ? 'text-base' : 'text-xl'} mb-8 md:mb-12 max-w-3xl mx-auto leading-relaxed opacity-90`}
          >
            Мы превратили дегустацию в восхождение: на каждом пролёте винтовой
            лестницы — полка с бутылками двух терруаров. Поднимаешься —
            сравниваешь стили, чувствуешь разницу климата и почв.
          </p>
          <div
            className={`flex ${isMobile ? 'flex-col' : 'flex-col sm:flex-row'} gap-4 justify-center ${isMobile ? 'w-full' : 'max-w-lg mx-auto'}`}
      ...
      {/* Features Section */}
      <section
        className={`${isMobile ? 'py-12 pb-20' : 'py-20'} bg-gradient-to-b from-background to-earth-light/20`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center ${isMobile ? 'mb-8' : 'mb-16'}`}>
            <h2
              className={`${isMobile ? 'text-2xl' : 'text-4xl md:text-5xl'} font-bold text-foreground mb-4 md:mb-6`}
            >
              Уникальный{' '}
            ...
            <p
              className={`${isMobile ? 'text-base' : 'text-xl'} text-muted-foreground max-w-3xl mx-auto leading-relaxed`}
            >
              Каждый пролёт лестницы — это новое открытие, новый терруар, новый
              вкус. Поднимайтесь по ступеням винного познания в атмосфере
              джунглей Бали.
            </p>
          </div>

          <div
            className={`grid ${isMobile ? 'grid-cols-1 gap-4' : 'grid-cols-1 md:grid-cols-2 gap-8'} ${isMobile ? 'mb-8' : 'mb-16'}`}
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 text-white">
                ...
                <p className="text-sm opacity-90">
                  Терруарные коллекции с QR-кодами
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 text-white">
                ...
                <p className="text-sm opacity-90">
                  Аутентичный декор и винные коллекции
                </p>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p className="flex items-start space-x-3">
                    ...
                    <span>
                      Выберите пролёт лестницы с интересующим вас сравнением
                      терруаров
                    </span>
                  </p>
                  <p className="flex items-start space-x-3">
                    ...
                    <span>
                      Наш сомелье проведёт дегустацию и расскажет о различиях
                    </span>
                  </p>
                  <p className="flex items-start space-x-3">
                    <span className="text-gold-accent font-bold">3.</span>
                    <span>
                      Поднимайтесь выше для новых открытий или останьтесь на
                      понравившемся уровне
                    </span>
                  </p>
                  <p className="flex items-start space-x-3">
                    <span className="text-gold-accent font-bold">4.</span>
                    <span>
                      Забронируйте целый марш для приватной вертикальной
                      дегустации
                    </span>
                  </p>
                </div>
