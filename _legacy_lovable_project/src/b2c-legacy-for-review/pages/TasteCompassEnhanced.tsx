            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-muted-foreground">
                  Исследуйте 8 вкусовых секторов и разблокируйте эксклюзивные
                  награды
                </p>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="mobile" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <p className="text-muted-foreground">
                  NFC сканирование, геолокация, push уведомления и камера для QR
                  кодов
                </p>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="social" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <p className="text-muted-foreground">
                  Сравните свой прогресс с друзьями, делитесь достижениями и
                  участвуйте в командных квестах
                </p>
              </CardHeader>
              <CardContent>
                <SocialTasteCompass />
          ...
          <TabsContent value="gamification" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <p className="text-muted-foreground">
                  Сезонные события, ежедневные квесты, специальные награды и
                  бонусные множители
                </p>
              </CardHeader>
              <CardContent>
