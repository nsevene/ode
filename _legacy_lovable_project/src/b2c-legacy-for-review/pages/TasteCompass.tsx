      ...
      <section className="relative min-h-screen bg-forest-dark">
        ...
        <div className="relative z-10 text-center flex flex-col items-center justify-center min-h-screen px-4">
          ...
          <div className="relative mb-16">
            <div className="w-80 h-80 md:w-96 md:h-96 rounded-full border-4 border-gold-accent relative overflow-hidden">
              {tasteCompassSectors.map((sector, index) => {
                ...
                const nextAngle =
                  (360 / tasteCompassSectors.length) * (index + 1);
                return (
                  <div
                    key={sector.name}
          ...
          <div className="max-w-4xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-cream-light mb-8">
              HOW IT WORKS
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-cream-light mb-2">
                  Tap NFC passport
                </h3>
              </div>
              <div className="text-center">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {eightZones.map((zone, index) => (
                <Card
                  key={index}
                  className="group cursor-pointer bg-forest-medium border-gold-accent/30 hover:border-gold-accent transition-all duration-300"
                >
