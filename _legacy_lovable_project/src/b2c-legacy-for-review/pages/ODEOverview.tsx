      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <section className="mb-16">
          ...
          <p className="text-center text-lg mb-8 text-muted-foreground">
            "Back to Origin. Forward to Yourself." В мире искусственного, ODE
            возвращает то, что реально.
          </p>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Tri Hita Karana: гармония с природой
                </p>
              </CardContent>
            </Card>
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  GastroVillage – Roots & Routes of Taste
                </p>
              </CardContent>
            </Card>
            <Card className="text-center">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Live cultures and fermented flavors
                </p>
              </CardContent>
            </Card>
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Ancient fire cooking traditions
                </p>
              </CardContent>
            </Card>
            <Card className="text-center hover:shadow-lg transition-shadow">
          ...
          <Card className="text-center max-w-2xl mx-auto">
            ...
            <CardContent>
              <p className="text-lg text-muted-foreground mb-2">
                51-meter journey through flavors
              </p>
              <p className="text-primary font-semibold">
                NFC Passport required
              </p>
            </CardContent>
          </Card>
        </section>
          ...
          <Card className="max-w-2xl mx-auto">
            <CardContent className="pt-6">
              <address className="not-italic text-center space-y-2">
                <p className="text-lg">
                  Jl. Monkey Forest No.15, Ubud, Bali 80571
                </p>
                <p>
                  Phone:{' '}
                  <a
                    href="tel:+6281943286395"
