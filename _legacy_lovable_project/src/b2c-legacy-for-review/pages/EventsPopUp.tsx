      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-gradient-to-r from-forest to-sage rounded-2xl text-white p-12 mb-12">
          <div className="max-w-4xl mx-auto text-center">
            <Badge className="bg-golden text-forest mb-4">
              Featured Pop-Up
            </Badge>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {upcomingEvents.map((event, index) => (
              <Card
                key={index}
                className="border-terracotta/30 hover:border-terracotta transition-colors"
              >
                <CardHeader>
        ...
        <Card className="bg-gradient-to-r from-golden/20 to-terracotta/20 border-golden/30">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Share your culinary vision with our community. Apply for a pop-up
              slot and showcase your unique cuisine.
            </p>
            <Button
              size="lg"
              variant="outline"
