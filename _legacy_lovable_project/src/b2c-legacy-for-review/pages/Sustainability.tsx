  ...
  const kpis = [
    {
      metric: 'Zero Waste',
      value: '95%',
      description: 'отходов перерабатывается',
    },
    {
      metric: 'Local Sourcing',
      value: '80%',
      description: 'продуктов от местных поставщиков',
    },
    {
      metric: 'Organic Ingredients',
      value: '100%',
      description: 'в Zero-Waste секторе',
    },
    {
      metric: 'Water Conservation',
      value: '40%',
      description: 'экономия воды',
    },
  ];
            ...
            <Card className="mb-12">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-lg">
                  Гармония с природой, людьми и духовностью — основа нашей
                  устойчивости
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div className="container mx-auto px-4">
            <Card>
              <CardHeader className="text-center">
                ...
                <CardDescription>
                  Botanical Lab & Chill — лаборатория устойчивости
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="container mx-auto px-4">
            <Card>
              <CardHeader className="text-center">
                ...
                <CardDescription>
                  Фермерский маркет каждое воскресенье 07:00–09:00
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center">
