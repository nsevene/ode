  ...
  const getMockQuests = (): Quest[] => [
    {
      ...
      duration: 60,
      requirements: [
        'Попробовать Pad Thai',
        'Попробовать Nasi Goreng',
        'Попробовать Curry',
        'Попробовать Sate',
        'Попробовать Tom Yum',
      ],
    ...
    },
    {
      ...
      duration: 90,
      requirements: [
        'Попробовать Babi Guling',
        'Попробовать Lawar',
        'Попробовать Gado-gado',
        'Узнать историю блюд',
        'Сфотографироваться с шеф-поваром',
      ],
      rewards: [
        '100 бонусных очков',
        'Эксклюзивный рецепт',
        'Значок "Heritage Keeper"',
      ],
      isCompleted: false,
      isLocked: false,
      progress: 20,
    ...
    },
    {
      ...
      duration: 120,
      requirements: [
        'Попробовать красное вино',
        'Попробовать белое вино',
        'Попробовать розовое вино',
        'Узнать о регионах',
        'Сделать заметки о вкусах',
      ],
      rewards: [
        '150 бонусных очков',
        'Сертификат дегустатора',
        'Значок "Wine Expert"',
      ],
      isCompleted: false,
      isLocked: false,
    ...
    },
    {
      ...
      duration: 75,
      requirements: [
        'Попробовать эспрессо',
        'Попробовать капучино',
        'Попробовать латте',
        'Узнать о сортах',
        'Сфотографировать процесс',
      ],
  ...
  const handleShareQuest = (quest: Quest) => {
    if (navigator.share) {
      ...
      navigator.clipboard.writeText(
        window.location.origin + `/taste-quest/${quest.id}`
      );
      toast({
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Отправьтесь в уникальное гастрономическое путешествие через 8
              вкусовых секторов
            </p>
              ...
              <div className="absolute inset-0 rounded-full bg-white shadow-lg">
                <svg viewBox="0 0 200 200" className="w-full h-full">
                  {compassSegments.map((segment, index) => {
                    ...
                    const nextAngle =
                      (360 / compassSegments.length) * (index + 1);
                    const x1 =
                    ...
                    const y2 =
                      100 + 80 * Math.sin(((nextAngle - 90) * Math.PI) / 180);
                    ...
                    return (
                      <g key={index}>
                        ...
                        <text
                          x={
                            100 +
                            60 * Math.cos(((angle + 22.5 - 90) * Math.PI) / 180)
                          }
                          y={
                            100 +
                            60 * Math.sin(((angle + 22.5 - 90) * Math.PI) / 180)
                          }
                          textAnchor="middle"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {achievements.map((achievement) => {
                  ...
                  return (
                    <Card
                      key={achievement.id}
                      className={`${achievement.isUnlocked ? 'ring-2 ring-yellow-500' : 'opacity-60'}`}
                    >
                      <CardContent className="p-6 text-center">
                        <div className="mb-4">
                          <IconComponent
                            className={`h-12 w-12 mx-auto ${achievement.isUnlocked ? 'text-yellow-500' : 'text-gray-400'}`}
                          />
                        </div>
                    ...
                    {[
                      ...
                      >
                        <div className="flex items-center gap-2">
                          {player.rank <= 3 ? (
                            <Trophy
                              className={`h-5 w-5 ${player.rank === 1 ? 'text-yellow-500' : player.rank === 2 ? 'text-gray-400' : 'text-orange-500'}`}
                            />
                          ) : (
                            <span className="w-5 h-5 text-center text-sm font-bold">
                              {player.rank}
                            </span>
                          )}
                        </div>
        ...
        <DialogContent className="max-w-2xl">
          ...
          {selectedQuest && (
            <div className="space-y-6">
              <div className="text-center">
                <selectedQuest.icon
                  className={`h-12 w-12 mx-auto ${selectedQuest.color} mb-4`}
                />
