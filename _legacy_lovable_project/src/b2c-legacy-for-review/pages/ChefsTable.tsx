      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Experience the ultimate culinary journey with our exclusive Chef's
            Table. A 6-course tasting menu prepared by our master chefs in an
            intimate setting.
          </p>
        </div>
              ...
              >
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    {chef.experience} of culinary excellence
                  </p>
        ...
        <section className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Limited seats available. Book your exclusive Chef's Table experience
            now.
          </p>
