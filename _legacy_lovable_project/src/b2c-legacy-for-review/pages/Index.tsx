...
const TasteCompassSection = lazy(
  () => import('@/components/TasteCompassSection')
);
...
const ExperiencesSection = lazy(
  () => import('@/components/ExperiencesSection')
);
const ARExperienceSection = lazy(
  () => import('@/components/ARExperienceSection')
);
const ReviewsSection = lazy(() => import('@/components/ReviewsSection'));
const FeaturedBarsSection = lazy(
  () => import('@/components/FeaturedBarsSection')
);
const BookingSection = lazy(() => import('@/components/BookingSection'));
const ColdDessertRetailSection = lazy(
  () => import('@/components/ColdDessertRetailSection')
);
const EnhancedContactSection = lazy(
  () => import('@/components/EnhancedContactSection')
);
...
const Index = () => {
          ...
          if (!profile?.referred_by) {
            ...
            if (!error) {
              toast({
                title: 'Welcome bonus!',
                description:
                  'You received 25 points for joining through a referral!',
              });
            }
          }
        } catch (error) {
  ...
  return (
    <>
      ...
      <PageLayout showMobileActions={false} variant="main">
