...
const resources = {
  en: {
    translation: {
      ...
      'about.description':
        'Back to Origin. Forward to Yourself. Farm → Kitchen → Your Table. Local farmers grow it. Our chefs cook it the same day. You taste real Bali—nothing extra, just fresh.',
      'about.concepts.earth.description':
        'Tri Hita Karana philosophy: harmony with nature, spiritual world and community',
      'about.concepts.journey.description':
        'GastroVillage – Roots & Routes of Taste. Exploring 8 taste sectors',
      'about.concepts.night.description':
        'Space transformation at sunset: wine staircase, sunset terrace',
      'about.concepts.bali.description':
        'Deep immersion in Balinese culture: 70%+ local ingredients',
      'about.concepts.compass.description':
        '8 taste sectors: from fermentation to umami, from spices to zero-waste',
      'about.concepts.lab.description':
        'Nothing artificial. Just ODE. Molecular mixology without alcohol with local herbs',
      'about.cta.title': '"Taste real. Feel home."',
      'about.cta.description':
        'Ready for a journey through 8 taste sectors? Start your Taste Quest today.',

      // Contact Section
      'contact.title': 'Contact',
      'contact.description':
        'Contact us for table reservations, event organization or any questions',
  ...
  zh: {
    translation: {
      ...
      'about.philosophy': '哲学',
      'about.description':
        '回归本源。向前成就自我。农场 → 厨房 → 您的餐桌。当地农民种植。我们的厨师当天烹饪。您品尝真正的巴厘岛——没有多余，只有新鲜。',
      'about.concepts.earth.description':
        'Tri Hita Karana哲学：与自然、精神世界和社区和谐',
      'about.concepts.journey.description':
        '美食村庄——味觉的根源与路线。探索8个味觉扇区',
      'about.concepts.night.description': '空间随日落转变：酒楼梯，日落露台',
      'about.concepts.bali.description': '深度沉浸巴厘文化：70%以上本地食材',
      'about.concepts.compass.description':
        '8个味觉扇区：从发酵到鲜味，从香料到零浪费',
      'about.concepts.lab.description':
        '无人工添加。只有ODE。本地草药分子调酒学不含酒精',
      'about.cta.title': '"品味真实。感受家的温暖。"',
      'about.cta.description':
        '准备好踏上8个味觉扇区的旅程吗？今天就开始您的味觉探索。',
  ...
  es: {
    translation: {
      ...
      'hero.description':
        '"De Vuelta al Origen. Hacia Ti Mismo." En un mundo artificial, ODE devuelve lo que es real.',
      'hero.location':
        'Ubud, Bali | Apertura: 1 de diciembre de 2025 | 1,800 m²',
      ...
      'about.description':
        'De Vuelta al Origen. Hacia Ti Mismo. Granja → Cocina → Tu Mesa. Los agricultores locales lo cultivan. Nuestros chefs lo cocinan el mismo día. Pruebas el verdadero Bali—nada extra, solo fresco.',
      'about.concepts.earth.description':
        'Filosofía Tri Hita Karana: armonía con la naturaleza, mundo espiritual y comunidad',
      'about.concepts.journey.description':
        'GastroVillage – Raíces y Rutas del Sabor. Explorando 8 sectores del sabor',
      'about.concepts.night.description':
        'Transformación del espacio al atardecer: escalera de vino, terraza del atardecer',
      'about.concepts.bali.description':
        'Inmersión profunda en la cultura balinesa: 70%+ ingredientes locales',
      'about.concepts.compass.description':
        '8 sectores del sabor: desde la fermentación hasta el umami, desde las especias hasta el desperdicio cero',
      'about.concepts.lab.description':
        'Nada artificial. Solo ODE. Mixología molecular sin alcohol con hierbas locales',
      'about.cta.title': '"Saborea lo real. Siéntete en casa."',
      'about.cta.description':
        '¿Listo para un viaje a través de 8 sectores del sabor? Comienza tu Búsqueda del Sabor hoy.',

      // Contact Section
      'contact.title': 'Contacto',
      'contact.description':
        'Contáctanos para reservas de mesa, organización de eventos o cualquier pregunta',
  ...
  de: {
    translation: {
      ...
      'hero.description':
        '"Zurück zum Ursprung. Vorwärts zu Dir Selbst." In einer Welt des Künstlichen kehrt ODE zum Echten zurück.',
      ...
      'about.description':
        'Zurück zum Ursprung. Vorwärts zu Dir Selbst. Bauernhof → Küche → Dein Tisch. Lokale Bauern bauen es an. Unsere Köche kochen es am selben Tag. Du schmeckst das echte Bali—nichts extra, nur frisch.',
      'about.concepts.earth.description':
        'Tri Hita Karana Philosophie: Harmonie mit Natur, spiritueller Welt und Gemeinschaft',
      'about.concepts.journey.description':
        'GastroDorf – Wurzeln und Wege des Geschmacks. Erkundung von 8 Geschmackssektoren',
      'about.concepts.night.description':
        'Raumtransformation bei Sonnenuntergang: Weintreppe, Sonnenuntergangsterrasse',
      'about.concepts.bali.description':
        'Tiefe Eintauchung in die balinesische Kultur: 70%+ lokale Zutaten',
      'about.concepts.compass.description':
        '8 Geschmackssektoren: von Fermentation zu Umami, von Gewürzen zu Zero-Waste',
      'about.concepts.lab.description':
        'Nichts Künstliches. Nur ODE. Molekulare Mixologie ohne Alkohol mit lokalen Kräutern',
      'about.cta.title': '"Schmecke das Echte. Fühle dich zu Hause."',
      'about.cta.description':
        'Bereit für eine Reise durch 8 Geschmackssektoren? Starte deine Geschmacksquest heute.',

      // Contact Section
      'contact.title': 'Kontakt',
      'contact.description':
        'Kontaktiere uns für Tischreservierungen, Eventorganisation oder Fragen',
      ...
      'contact.form.errorDesc':
        'Nachricht konnte nicht gesendet werden. Versuchen Sie es später.',
  ...
  id: {
    translation: {
      ...
      'hero.description':
        '"Kembali ke Asal. Maju ke Dirimu." Di dunia yang artifisial, ODE mengembalikan yang asli.',
      ...
      'about.description':
        'Kembali ke Asal. Maju ke Dirimu. Ladang → Dapur → Meja Anda. Petani lokal menanamnya. Koki kami memasaknya di hari yang sama. Anda merasakan Bali yang asli—tidak ada yang berlebihan, hanya segar.',
      'about.concepts.earth.description':
        'Filosofi Tri Hita Karana: keharmonisan dengan alam, dunia spiritual dan komunitas',
      'about.concepts.journey.description':
        'GastroVillage – Akar & Rute Rasa. Menjelajahi 8 sektor rasa',
      'about.concepts.night.description':
        'Transformasi ruang saat matahari terbenam: tangga wine, teras sunset',
      'about.concepts.bali.description':
        'Penyelaman mendalam dalam budaya Bali: 70%+ bahan lokal',
      'about.concepts.compass.description':
        '8 sektor rasa: dari fermentasi hingga umami, dari rempah hingga zero-waste',
      'about.concepts.lab.description':
        'Tidak ada yang artifisial. Hanya ODE. Mixologi molekuler tanpa alkohol dengan herbal lokal',
      'about.cta.title': '"Rasakan yang asli. Rasakan rumah."',
      'about.cta.description':
        'Siap untuk perjalanan melalui 8 sektor rasa? Mulai Pencarian Rasa Anda hari ini.',

      // Contact Section
      'contact.title': 'Kontak',
      'contact.description':
        'Hubungi kami untuk reservasi meja, organisasi acara atau pertanyaan apa pun',
  ...
  ms: {
    translation: {
      ...
      'hero.description':
        '"Kembali ke Asal. Maju ke Diri." Di dunia yang tiruan, ODE mengembalikan yang asli.',
      ...
      'about.description':
        'Kembali ke Asal. Maju ke Diri. Ladang → Dapur → Meja Anda. Petani tempatan menanamnya. Tukang masak kami memasaknya pada hari yang sama. Anda merasai Bali yang asli—tiada yang berlebihan, hanya segar.',
      'about.concepts.earth.description':
        'Falsafah Tri Hita Karana: keharmonian dengan alam, dunia spiritual dan komuniti',
      'about.concepts.journey.description':
        'GastroVillage – Akar & Laluan Rasa. Meneroka 8 sektor rasa',
      'about.concepts.night.description':
        'Transformasi ruang semasa matahari terbenam: tangga wain, teres sunset',
      'about.concepts.bali.description':
        'Penyelaman mendalam dalam budaya Bali: 70%+ ramuan tempatan',
      'about.concepts.compass.description':
        '8 sektor rasa: dari penapaian hingga umami, dari rempah hingga sifar sisa',
      'about.concepts.lab.description':
        'Tiada yang tiruan. Hanya ODE. Mixologi molekul tanpa alkohol dengan herba tempatan',
      'about.cta.title': '"Rasa yang asli. Rasa rumah."',
      'about.cta.description':
        'Bersedia untuk perjalanan melalui 8 sektor rasa? Mula Pencarian Rasa Anda hari ini.',

      // Contact Section
      'contact.title': 'Hubungi',
      'contact.description':
        'Hubungi kami untuk tempahan meja, organisasi acara atau sebarang pertanyaan',
      'contact.address': 'Alamat',
      'contact.phone': 'Telefon',
      'contact.email': 'Email',
