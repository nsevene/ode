...
export const sendBookingConfirmation = async (
  email: string,
  bookingData: BookingConfirmationEmail
): Promise<boolean> => {
...
export const createTenantApplicationConfirmationEmail = (
  data: TenantApplicationConfirmationEmail
): EmailTemplate => {
  return {
...
export const sendTenantApplicationConfirmation = async (
  email: string,
  applicationData: TenantApplicationConfirmationEmail
): Promise<boolean> => {
