...
const DemoOrderFlow = () => {
  const [currentStep, setCurrentStep] = useState<
    'menu' | 'customize' | 'cart' | 'payment' | 'confirmation'
  >('menu');
  ...
  const demoMenuItems = [
    {
      ...
      description:
        'Traditional Thai stir-fried rice noodles with tamarind, palm sugar, and fresh herbs',
      price: 85000,
      ...
      customizations: [
        {
          type: 'Spice Level',
          options: ['Mild', 'Medium', 'Spicy', 'Thai Hot'],
          default: 'Medium',
        },
        {
          type: 'Protein',
    ...
    },
    {
      ...
      description:
        'Classic Neapolitan pizza with San Marzano tomatoes, buffalo mozzarella, and fresh basil',
      price: 105000,
      ...
      customizations: [
        {
          ...
          default: 'Personal (25cm)',
        },
        {
          type: 'Crust',
          options: ['Traditional Thin', 'Thick Roman', 'Gluten-Free (+12k)'],
          default: 'Traditional Thin',
        },
        {
          type: 'Extra Toppings',
          options: [
    ...
    },
    {
      ...
      description:
        'Traditional Balinese rice platter with rendang, satay, vegetables, and sambal',
      price: 75000,
      ...
      customizations: [
        ...
        },
        {
          ...
          default: 'Steamed White Rice',
        },
        {
          type: 'Spice Level',
          options: ['Mild Sambal', 'Medium Sambal', 'Spicy Sambal'],
          default: 'Medium Sambal',
        },
      ],
    },
    {
      ...
      description:
        'Slow-smoked beef brisket with house BBQ sauce, coleslaw, and cornbread',
      price: 145000,
      ...
      customizations: [
        {
          type: 'Cut Style',
          options: ['Lean Cut', 'Fatty Cut', 'Mixed Cut'],
          default: 'Mixed Cut',
        },
        {
          type: 'Sauce',
    ...
    },
    {
      ...
      name: 'Tonkotsu Ramen',
      description:
        'Rich pork bone broth with chashu, soft egg, nori, and fresh noodles',
      price: 95000,
      ...
      customizations: [
        {
          type: 'Broth Richness',
          options: ['Light', 'Regular', 'Extra Rich'],
          default: 'Regular',
        },
        {
          type: 'Noodle Firmness',
          options: ['Soft', 'Regular', 'Firm'],
          default: 'Regular',
        },
        {
          type: 'Toppings',
    ...
    },
    {
      ...
      name: 'Dragon Bowl',
      description:
        'Quinoa, roasted vegetables, avocado, hemp seeds, and tahini dressing',
      price: 68000,
    ...
    },
    {
      ...
      description:
        'Grilled mahi-mahi with mango salsa, cabbage slaw, and chipotle mayo',
      price: 78000,
      ...
      customizations: [
        {
          type: 'Quantity',
          options: ['2 Tacos', '3 Tacos (+12k)', '4 Tacos (+20k)'],
          default: '2 Tacos',
        },
        {
          type: 'Protein',
          ...
          default: 'Grilled Fish',
        },
        {
          type: 'Sides',
          options: ['Elote (+8k)', 'Guacamole (+6k)', 'Churros (+12k)'],
          default: [],
        },
      ],
    },
    {
      ...
      description:
        'Braised chicken in red wine with pearl onions, mushrooms, and herbs',
      price: 125000,
      ...
      customizations: [
        {
          ...
          options: [
            'Burgundy Style',
            'Local Red Wine',
            'White Wine Version (+8k)',
          ],
          default: 'Burgundy Style',
        },
        {
          type: 'Side Dish',
          options: [
          ...
          default: 'Garlic Mashed Potato',
        },
        {
          type: 'Portion',
          options: ['Regular', 'Large (+15k)'],
          default: 'Regular',
        },
      ],
    },
  ...
  const handleItemSelect = (item: any) => {
    ...
    setCustomizations({
      'Spice Level':
        item.customizations?.find((c: any) => c.type === 'Spice Level')
          ?.default || '',
      Protein:
        item.customizations?.find((c: any) => c.type === 'Protein')?.default ||
        '',
      Size:
        item.customizations?.find((c: any) => c.type === 'Size')?.default || '',
      Crust:
        item.customizations?.find((c: any) => c.type === 'Crust')?.default ||
        '',
      'Add-ons': [],
      'Extra Toppings': [],
    });
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-center">
        <div className="flex items-center gap-2 bg-pure-white rounded-full p-2 border border-cream-medium">
          {['menu', 'customize', 'cart', 'payment', 'confirmation'].map(
            (step, index) => (
              <div
                key={step}
              ...
              >
                <CardContent className="p-4">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="font-bold text-burgundy-primary">
            ...
            <CardContent className="p-6">
              ...
              {selectedItem.customizations?.map((customization: any) => (
                <div key={customization.type} className="mb-6">
                  <h4 className="font-medium text-charcoal-dark mb-3">
                    {customization.type}
                  </h4>
                  <div className="grid grid-cols-2 gap-2">
                    {customization.options.map((option: string) => (
                      <Button
                        key={option}
                        variant={
                          customizations[customization.type] === option
                            ? 'default'
                            : 'outline'
                        }
                        size="sm"
                        onClick={() => {
                          if (
                            customization.type === 'Add-ons' ||
                            customization.type === 'Extra Toppings'
                          ) {
                            const current =
                              customizations[customization.type] || [];
                            setCustomizations({
                              ...customizations,
          ...
          <Card className="max-w-2xl mx-auto bg-pure-white/80 backdrop-blur">
            <CardContent className="p-6">
              ...
              {cartItems.map((item) => (
                <div
                  key={item.cartId}
                  className="flex justify-between items-start p-4 border border-cream-medium rounded-lg mb-4"
                >
                  <div>
                    <h4 className="font-medium text-charcoal-dark">
                      {item.name}
                    </h4>
                    ...
                    <div className="text-xs text-charcoal-medium mt-1">
                      {Object.entries(
                        item.customizations as Record<string, string | string[]>
                      ).map(([key, raw]) => {
                        const value = raw as string | string[];
                        if (!value) return null;
                        const isArray = Array.isArray(value);
                        if (isArray && (value as string[]).length === 0)
                          return null;
                        return (
          ...
          <Card className="max-w-md mx-auto bg-pure-white/80 backdrop-blur">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-charcoal-medium mb-4">
                This is a payment simulation. No real transactions will be
                processed.
              </p>
              <div className="bg-cream-light rounded-lg p-4 mb-6">
                <div className="text-sm text-charcoal-medium mb-2">
                  Order Total:
                </div>
                <div className="text-2xl font-bold text-burgundy-primary">
                  {formatPrice(getTotalPrice())}
                </div>
              </div>
              <Button
        ...
        {currentStep === 'confirmation' && (
          <Card className="max-w-md mx-auto bg-pure-white/80 backdrop-blur">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-charcoal-medium mb-4">
                Demo order #ODE{Date.now().toString().slice(-6)} has been placed
                successfully.
              </p>
              <div className="bg-cream-light rounded-lg p-4 mb-6">
