  ...
  const guestSteps = [
    {
      ...
      description:
        'Discover how visitors explore our food hall through an interactive demo.',
    ...
    },
    {
      ...
      description:
        'Browse 8-12 curated local kitchens with smart dietary filters.',
    ...
    },
    {
      ...
      description:
        'Complete missions across taste zones to unlock rewards and badges.',
    ...
    },
    {
      ...
      description:
        'Everything is demo-only. No real transactions or personal data required.',
  ...
  const partnerSteps = [
    {
      ...
      description:
        'See how we help partners model their ROI with real market data.',
    ...
    },
    {
      ...
      description:
        'Input your parameters and see payback calculations instantly.',
    ...
    },
    {
      ...
      description:
        'Dashboard mockup showing sales analytics and promotional tools.',
      icon: <Sparkles className="w-6 h-6 text-burgundy-primary" />,
    ...
    },
    {
      ...
      description:
        'All numbers are illustrative examples based on market research.',
      icon: <ChevronRight className="w-6 h-6 text-charcoal-dark" />,
