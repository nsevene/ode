  ...
  const journeySteps = [
    {
      ...
      description:
        'Guest discovers Ode through social media, reviews, or word-of-mouth',
    ...
    },
    {
      ...
      description:
        'Guest enters and experiences our ambiance, layout, and initial service',
    ...
    },
    {
      ...
      description:
        'Guest receives order, dines, and potentially explores other areas',
    ...
    },
    {
      ...
      description:
        'Guest leaves with intention to return and potentially shares experience',
    ...
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            >
              <div className="text-xl font-bold">
                {overallMetrics.totalVisitors.toLocaleString()}
              </div>
            ...
            >
              <div className="text-xl font-bold">
                {overallMetrics.conversionToOrder}%
              </div>
              <div className="text-xs text-burgundy-light">
                Order Conversion
              </div>
            ...
            >
              <div className="text-xl font-bold">
                {overallMetrics.avgSessionTime} min
              </div>
            ...
            >
              <div className="text-xl font-bold">
                {overallMetrics.tastePassportAdoption}%
              </div>
              <div className="text-xs text-burgundy-light">
                Passport Adoption
              </div>
              ...
              {selectedStep === step.id && (
                <div className="mt-4 pt-4 border-t border-cream-medium">
                  <div className="grid md:grid-cols-3 gap-4">
                    <div>
                      <h5 className="font-medium text-charcoal-dark mb-2 text-sm">
                        Drop-off Reasons
                      </h5>
                      ...
                      <div className="space-y-1">
                        {Object.entries(step.metrics).map(([key, value]) => (
                          ...
                          >
                            ...
                            <span className="font-medium text-burgundy-primary">
                              {value}
                            </span>
                          </div>
                        ))}
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between p-3 bg-pure-white rounded-lg">
                  ...
                  <span className="text-sm font-bold text-burgundy-primary">
                    Rp 23k potential
                  </span>
                </div>
                <div className="flex items-center justify-between p-3 bg-pure-white rounded-lg">
      ...
      <div className="text-center bg-cream-light/50 rounded-lg p-6">
        ...
        <p className="text-sm text-charcoal-medium mb-4">
          Live tracking of guest behavior, conversion funnel analysis, and
          automated optimization recommendations help partners maximize revenue
          at every touchpoint.
        </p>
