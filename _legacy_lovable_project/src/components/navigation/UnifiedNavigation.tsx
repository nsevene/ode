...
export const UnifiedNavigation: React.FC<UnifiedNavigationProps> = ({
  ...
  if (variant === 'portal') {
    return (
      <nav
        className={cn(
          'bg-card border-r border-border fixed left-0 top-0 h-full w-64 z-50',
          className
        )}
      >
        <div className="p-6">
            ...
            <div className="flex items-center">
              ...
              >
                <div className="flex flex-col justify-center">
                  <div className="text-xl font-bold text-foreground group-hover:text-primary transition-colors leading-tight">
                    ODE
                  </div>
                </div>
              </Link>
