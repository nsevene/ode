    ...
    <div className="sticky top-20 left-4 right-4 z-60 mx-4 mb-6">
      <div className="bg-white/95 backdrop-blur-sm rounded-xl p-3 shadow-md border border-cream-medium/30">
        <div className="grid grid-cols-4 gap-2">
          ...
          <Link
            to="/taste-quest"
            className="flex flex-col items-center p-2 rounded-lg bg-sage-blue/10 hover:bg-sage-blue/20 transition-colors"
          >
          ...
          <Link
            to="/kitchens"
            className="flex flex-col items-center p-2 rounded-lg bg-forest-green/10 hover:bg-forest-green/20 transition-colors"
          >
          ...
          <Link
            to="/spaces"
            className="flex flex-col items-center p-2 rounded-lg bg-burgundy-primary/10 hover:bg-burgundy-primary/20 transition-colors"
          >
