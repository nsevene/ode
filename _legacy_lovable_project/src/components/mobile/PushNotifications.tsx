        ...
        <CardContent>
          <div className="space-y-4">
            ...
            {isSupported && !isEnabled && (
              <div className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  Разрешите уведомления, чтобы получать важные обновления о
                  ваших бронированиях и новых предложениях.
                </p>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updatePreferences('bookingReminders', checked)
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updatePreferences('events', checked)
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updatePreferences('questUpdates', checked)
                  }
                />
              </div>
