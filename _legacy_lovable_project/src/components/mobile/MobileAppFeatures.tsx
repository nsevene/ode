...
const MobileAppFeatures = () => {
  ...
  const checkMobileCapabilities = async () => {
    ...
    if (typeof window !== 'undefined' && (window as any).Capacitor) {
      ...
      // Placeholder for actual NFC logic
      try {
        if (Capacitor.isPluginAvailable('Nfc')) {
          // const { NFC } = await import('@capacitor-community/nfc');
          console.log('NFC Plugin is available');
          // Example: await NFC.addListener('nfcTagScanned', (tag) => console.log(tag));
        } else {
          console.warn('NFC Plugin not available on this platform.');
        }
      } catch (error) {
  ...
  const mobileFeatures = [
    {
      ...
      description:
        'Scan NFC tags at each taste zone to unlock experiences and earn points',
      icon: Nfc,
    ...
    },
    {
      ...
      description:
        'Scan QR codes for instant menu access, payments, and special offers',
      icon: QrCode,
      available: true,
      features: [
        'Menu scanning',
    ...
    },
    {
      ...
      description:
        'Auto-detect your zone for location-based missions and personalized offers',
      icon: MapPin,
    ...
    },
    {
      title: 'Offline Mode',
      description:
        'Access your taste passport and order history even without internet',
      icon: Wifi,
      available: true,
      features: [
        'Offline passport',
  ...
  const appBenefits = [
    ...
    },
    {
      title: 'Gamification',
      description:
        'Complete missions and earn rewards as you explore different cuisines',
      icon: Star,
    },
    {
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="text-center">
              <Badge
                variant={nfcAvailable ? 'default' : 'secondary'}
                className="mb-2"
              >
            ...
            <div className="text-center">
              <Badge
                variant={locationPermission ? 'default' : 'secondary'}
                className="mb-2"
              >
