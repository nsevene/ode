  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const submitData = {
        ...
        ...formData,
        lease_start_date:
          formData.lease_start_date?.toISOString().split('T')[0] || null,
      };
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      investment_budget: e.target.value,
                    })
                  }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Popover>
                  ...
                  <PopoverContent className="w-auto p-0" align="start">
                    <Calendar
                      ...
                      onSelect={(date) =>
                        setFormData({ ...formData, lease_start_date: date })
                      }
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormData({ ...formData, lease_duration: value })
                  }
                >
                  <SelectTrigger>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="best_contact_time">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setFormData({
                    ...formData,
                    has_food_license: checked as boolean,
                  })
                }
              />
            ...
            <div>
              <Label htmlFor="previous_experience">
                Предыдущий опыт в сфере общепита
              </Label>
              <Textarea
