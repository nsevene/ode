...
const BOOKING_FUNNEL_STEPS = [
  {
    ...
    description: 'Пользователи попали на главную',
  },
  {
    id: 'browse',
    name: 'Просмотр услуг',
    description: "Изучают Taste Alley или Chef's Table",
  },
  {
    id: 'select',
    name: 'Выбор услуги',
    description: 'Выбрали конкретную услугу',
  },
  {
    id: 'booking_form',
    name: 'Форма бронирования',
    description: 'Открыли форму бронирования',
  },
  {
    id: 'form_filled',
    name: 'Заполнение формы',
    description: 'Заполнили основную информацию',
  },
  {
    id: 'payment',
    name: 'Переход к оплате',
    description: 'Нажали кнопку оплаты',
  },
  {
    id: 'completed',
    name: 'Завершение',
    description: 'Успешно завершили бронирование',
  },
];
...
export const FunnelAnalytics: React.FC = () => {
  ...
  const currentFunnel = funnelData.find((f) =>
    f.name.toLowerCase().includes(selectedFunnel)
  );
        ...
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Отслеживание пути пользователей от посещения до завершения
              бронирования
            </p>
          </div>
        ...
        <CardContent>
          <div className="space-y-4">
            {currentFunnel.steps.map((step, index) => {
              ...
              const widthPercent =
                (step.count / currentFunnel.totalUsers) * 100;
                  ...
                  <div className="relative">
                    ...
                    {step.conversionRate && (
                      <Badge
                        ...
                        variant={
                          step.conversionRate >= 70 ? 'default' : 'secondary'
                        }
                      >
                        {step.conversionRate}%
                      </Badge>
