...
export const LocalBusinessSchema = ({
  ...
  const schema = {
    ...
    description:
      "ODE Food Hall in Ubud - a unique gastronomic complex of 1,800 m² with 8 culinary sectors, Chef's Table, Wine Staircase and interactive experiences. Opening December 1, 2025.",
