...
export const HomePageSEO: React.FC = () => (
  <PageSEO
    ...
    structuredData={{
      ...
      name: 'ODE Food Hall',
      description:
        "Innovative gastro village with 12 food corners, Wine Staircase tastings, Chef's Table experiences & commercial kitchen rental for restaurants",
      url: 'https://odefoodhall.com',
      logo: 'https://odefoodhall.com/lovable-uploads/3f00f862-daaa-4d2d-b462-b7347e9e5cdb.png',
      image:
        'https://odefoodhall.com/lovable-uploads/3f00f862-daaa-4d2d-b462-b7347e9e5cdb.png',
      address: {
        '@type': 'PostalAddress',
