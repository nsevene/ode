...
const AnalyticsSetup: React.FC<AnalyticsSetupProps> = ({ className = '' }) => {
  ...
  const [tests, setTests] = useState<TrackingTest[]>([
    {
      ...
      description: 'Отслеживание просмотров страниц',
      status: 'pending',
    },
    {
      name: 'Meta Pixel',
      description: 'Отслеживание конверсий Facebook/Instagram',
      status: 'pending',
    },
    {
      name: 'Event Tracking',
      description: 'Кастомные события (клики, формы)',
      status: 'pending',
    },
    {
      name: 'Конверсии',
      description: 'Отслеживание бронирований и заказов',
      status: 'pending',
    },
  ]);
        ...
        case 'Google Analytics':
          ...
          return {
            ...
            result: hasGA
              ...
              : 'Не найден или неправильно настроен',
          };
  ...
  const saveConfig = () => {
    ...
    alert(
      'Конфигурация сохранена! Перезагрузите страницу для применения изменений.'
    );
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setConfig((prev) => ({ ...prev, hotjarId: e.target.value }))
                }
                placeholder="12345"
              />
              <p className="text-xs text-gray-500">
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="p-4 bg-purple-50 rounded-lg">
              ...
              <ul className="text-sm space-y-1 text-gray-700">
                <li>
                  • Используйте расширения: Google Analytics Debugger, Facebook
                  Pixel Helper
                </li>
