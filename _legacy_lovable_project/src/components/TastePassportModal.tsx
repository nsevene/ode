...
export const TastePassportModal = ({
  isOpen,
  onClose,
}: TastePassportModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const passportId =
        'ODE' + Math.random().toString(36).substr(2, 8).toUpperCase();
        ...
        <div className="space-y-6">
          <div className="text-center space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Explore all flavors, collect achievements, and get exclusive
              bonuses!
            </p>
          </div>
