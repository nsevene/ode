            ...
            <>
                  ...
                  <Card key={item.id} className="p-4">
                    <div className="flex gap-3">
                      <img
                        src={
                          item.image_url ||
                          '/lovable-uploads/3f00f862-daaa-4d2d-b462-b7347e9e5cdb.png'
                        }
                        alt={item.name}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="mt-3">
                          <Textarea
                            ...
                            onChange={(e) =>
                              onUpdateSpecialRequests(item.id, e.target.value)
                            }
                            className="text-xs"
                            rows={2}
                          />
              ...
              {orderType === 'delivery' && (
                <div className="mb-6">
                  ...
                  <Textarea placeholder="Введите адрес доставки..." rows={3} />
                </div>
              )}
