...
const SpaceBookingManagement: React.FC = () => {
  ...
  const addComment = async () => {
    ...
    try {
      ...
      const { error } = await supabase.from('space_booking_comments').insert([
        {
                ...
                <Card>
                  ...
                  <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p>
                        {selectedBooking.preferred_contact_method ||
                          'Не указано'}
                      </p>
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="internal">
                          Внутренний комментарий (не видим заявителю)
                        </Label>
                      </div>
                      <Button
                        onClick={addComment}
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="flex gap-3">
                      ...
                      >
                        <Clock className="w-4 h-4 mr-1" />В ожидание
                      </Button>
                    </div>
                  </CardContent>
                </Card>
