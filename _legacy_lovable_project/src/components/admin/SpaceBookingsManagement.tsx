...
const SpaceBookingsManagement = () => {
  ...
  const [selectedBooking, setSelectedBooking] = useState<SpaceBooking | null>(
    null
  );
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4 mt-2 text-sm text-muted-foreground">
                      <div className="flex items-center gap-1">
                        ...
                        <span>
                          {booking.space_name} ({booking.space_area} м²,{' '}
                          {booking.floor_number} этаж)
                        </span>
                      </div>
                      <div className="flex items-center gap-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="space-y-1 text-sm">
                      ...
                      <p>
                        <strong>Предпочитаемый способ связи:</strong>{' '}
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-sm">
                      <p>
                        <strong>Тип бизнеса:</strong> {booking.business_type}
                      </p>
                      {booking.cuisine_type && (
                        <p>
                          <strong>Тип кухни:</strong> {booking.cuisine_type}
                        </p>
                      )}
                      <p>
                        <strong>Длительность аренды:</strong>{' '}
                        {booking.lease_duration}
                      </p>
                      ...
                      <p>
                        <strong>Лицензия на продукты:</strong>{' '}
                        {booking.has_food_license ? 'Есть' : 'Нет'}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      {booking.expected_revenue && (
                        <p>
                          <strong>Ожидаемая выручка:</strong>{' '}
                          {booking.expected_revenue}
                        </p>
                      )}
                      {booking.investment_budget && (
                        <p>
                          <strong>Инвестиционный бюджет:</strong>{' '}
                          {booking.investment_budget}
                        </p>
                      )}
                    </div>
