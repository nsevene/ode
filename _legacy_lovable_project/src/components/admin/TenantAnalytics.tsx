...
const TenantAnalytics: React.FC = () => {
  ...
  const loadAnalyticsData = async () => {
    try {
      ...
      const applicationsByMonth = processApplicationsByMonth(
        applications || []
      );
      ...
      const applicationsBySector = processApplicationsBySector(
        applications || []
      );

      // Communication stats
      const communicationStats = processCommunicationStats(
        communications || []
      );
  ...
  const exportAnalytics = () => {
    ...
    const csvData = [
      ...
      ['', ''],
      ['Applications by Month', ''],
      ...analyticsData.applicationsByMonth.map((item) => [
        item.month,
        item.applications,
      ]),
      ['', ''],
      ['Applications by Sector', ''],
      ...analyticsData.applicationsBySector.map((item) => [
        item.sector,
        item.count,
      ]),
    ];
        ...
        <TabsContent value="applications">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Monthly application submission trends
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="sectors">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Preferred sectors for tenant applications
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Breakdown of communication methods
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Current status of scheduled meetings
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
