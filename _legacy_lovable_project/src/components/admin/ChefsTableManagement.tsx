...
const ChefsTableManagement = () => {
  ...
  const fetchStats = async () => {
    try {
      ...
      const averageGuests =
        totalBookings > 0
          ? data.reduce((sum, booking) => sum + booking.guest_count, 0) /
            totalBookings
          : 0;
      const upcomingEvents =
        data?.filter((booking) => new Date(booking.booking_date) >= new Date())
          .length || 0;
      ...
      <Tabs defaultValue="bookings" className="w-full">
        ...
        <TabsContent value="bookings" className="space-y-4">
          ...
          <Card>
            <CardHeader>
              <CardTitle>
                Список бронирований ({filteredBookings.length})
              </CardTitle>
            </CardHeader>
            <CardContent>
                          ...
                          <DialogContent>
                            ...
                            <div className="space-y-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm">
                                  {booking.special_requests || 'Нет'}
                                </p>
                              </div>
                              <div>
                                <Label>NFC Passport</Label>
                                <p className="text-sm">
                                  {booking.nfc_passport_id || 'Не активирован'}
                                </p>
                              </div>
                            </div>
                          </DialogContent>
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    В настоящее время Chef's Table работает 5 дней в неделю
                    (вторник-суббота)
                  </p>
                </div>
                <div>
        ...
        <TabsContent value="settings" className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <Label htmlFor="wine-pairing">
                  Доплата за винное сопровождение (USD)
                </Label>
                <Input id="wine-pairing" type="number" defaultValue="15" />
              </div>
              <div>
                <Label htmlFor="kombucha-pairing">
                  Доплата за комбуча-пару (USD)
                </Label>
