...
const ApplicationsManagement: React.FC = () => {
  ...
  const handleStatusChange = async (
    ...
    try {
      const { error } = await applicationApi.updateStatus(
        applicationId,
        newStatus,
        notes
      );
  ...
  const handleApprove = async (application: Application) => {
    if (
      !confirm(
        'Вы уверены, что хотите одобрить эту заявку? Это создаст пользователя и назначит роль.'
      )
    )
      return;
    setIsApproving(true);
            ...
            <TableBody>
              {filteredApplications.map((application) => (
                <TableRow key={application.id}>
                  ...
                  <TableCell>
                    <span className="font-medium">
                      ₽{application.investment_amount.toLocaleString()}
                    </span>
                  </TableCell>
                  <TableCell>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {selectedApplication.experience_years} лет
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {selectedApplication.proposed_location}
                    </p>
                  </div>
                  <div>
                    <Label>Размер инвестиций</Label>
                    <p className="font-medium">
                      ₽{selectedApplication.investment_amount.toLocaleString()}
                    </p>
                  </div>
                </div>
              </div>
