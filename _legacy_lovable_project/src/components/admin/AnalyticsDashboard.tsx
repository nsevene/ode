    ...
    <div className="container mx-auto py-8 px-4">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Manage your food hall operations and analytics
        </p>
      </div>
        ...
        <TabsContent value="analytics" className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <BarChart data={mockAnalyticsData.bookings}>
                    ...
                    <Tooltip
                      formatter={(value, name) => [
                        name === 'count'
                          ? value
                          : `IDR ${(value as number).toLocaleString()}`,
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Distribution of bookings by experience type
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                User journey from landing to completion
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  >
                    ...
                    <div className="text-right">
                      <p className="font-bold">
                        IDR {upsell.revenue.toLocaleString()}
                      </p>
        ...
        <TabsContent value="realtime" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Live user activity and analytics events
              </CardDescription>
            </CardHeader>
            <CardContent>
