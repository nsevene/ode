...
-- Drop existing insecure policies for support_chats
...
-- Drop existing insecure policies for support_messages  
...
CREATE POLICY "Authenticated users can view own chat messages" 
