...
const CommunityHub = () => {
  ...
  const [reviews, setReviews] = useState<Review[]>([
    {
      ...
      content: 'Попробовала карбонару в Dolce Italia - это было невероятно! Паста идеально приготовлена, соус очень вкусный. Обязательно вернусь снова.',
      images: [
      ...
      replies: [
        {
          ...
          userAvatar: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=100&h=100&fit=crop',
    ...
    },
    {
      ...
      content: 'Заказал пад тай - получилось очень вкусно! Острота в самый раз. Единственное - порция могла бы быть больше.',
      images: [],
  ...
  const filteredReviews = reviews.filter(review => {
    ...
    const matchesVendor = filterVendor === 'all' || review.vendorId === filterVendor;
              ...
              <CardContent className="space-y-4">
                ...
                {review.replies.length > 0 && (
                  <div className="border-t pt-4">
                    <h4 className="font-medium mb-3">Ответы ({review.replies.length})</h4>
                        ...
                        <div key={reply.id} className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              ...
                              {reply.isVendorReply && (
                                <Badge variant="outline" className="text-xs">Вендор</Badge>
                              )}
                ...
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <div className="flex">{getRatingStars(Math.round(vendor.rating))}</div>
                        <span className="text-sm text-muted-foreground">
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="text-center">
                ...
                <p className="text-gray-500">Обсуждения будут доступны в следующей версии</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
