...
export const SimpleBookingModal = ({ isOpen, onClose }: SimpleBookingModalProps) => {
  ...
  const selectedExperience = QUICK_EXPERIENCES.find(e => e.id === formData.experience);
      ...
      <DialogContent className="max-w-md">
        ...
        {step === 1 ? (
          <div className="space-y-6">
            ...
            <Button 
              onClick={handleNext} 
              disabled={!formData.experience || !formData.date || !formData.time}
              className="w-full"
            >
              Далее
            </Button>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-muted/50 p-4 rounded-lg space-y-2">
              ...
              <div className="flex justify-between text-sm text-muted-foreground">
                <span>{formData.guests} гостей • {formData.date && format(formData.date, "dd MMM", { locale: ru })} • {formData.time}</span>
              </div>
