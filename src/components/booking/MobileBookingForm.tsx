    ...
    <Card className={`w-full ${isMobile ? 'shadow-lg' : ''}`}>
      ...
      <CardContent className={`space-y-${isMobile ? '6' : '4'}`}>
        ...
        <div className="space-y-3">
          ...
          <div className={`grid grid-cols-${Math.min(maxGuests, isMobile ? 4 : 6)} gap-2`}>
        ...
        <div className="space-y-4">
          <div className="space-y-3">
            <Label htmlFor="guest-name" className={`${labelClasses} flex items-center gap-2`}>
          ...
          <div className="space-y-3">
            <Label htmlFor="guest-email" className={`${labelClasses} flex items-center gap-2`}>
          ...
          <div className="space-y-3">
            <Label htmlFor="guest-phone" className={`${labelClasses} flex items-center gap-2`}>
          ...
          <div className="space-y-3">
            <Label htmlFor="special-requests" className={`${labelClasses} flex items-center gap-2`}>
