  ...
  const loadStats = async () => {
    ...
    if (gameResults) {
      const avgScore = gameResults.length > 0 
        ? gameResults.reduce((sum, result) => sum + (result.score || 0), 0) / gameResults.length 
        : 0;
    ...
    if (questProgress) {
      ...
      const completionRate = questProgress.length > 0 
      ...
      setQuestStats({
        ...
        totalRewards: quests.reduce((sum, quest) => sum + quest.reward_points, 0)
      });
    }
  };
    ...
    <div className="container mx-auto p-6 space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Создавайте и управляйте мини-играми и ежедневными квестами</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Игровых сессий</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Выполнение квестов</CardTitle>
            <TrendingUp className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{questStats.completionRate}%</div>
            <p className="text-xs text-muted-foreground">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Select value={gameForm.game_type} onValueChange={(value: any) => setGameForm(prev => ({ ...prev, game_type: value }))}>
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                    ...
                    <div>
                      ...
                      <Select value={gameForm.difficulty} onValueChange={(value: any) => setGameForm(prev => ({ ...prev, difficulty: value }))}>
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setGameForm(prev => ({ ...prev, base_points: Number(e.target.value) }))}
                        min="1"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setGameForm(prev => ({ ...prev, time_limit: Number(e.target.value) }))}
                        min="10"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setGameForm(prev => ({ ...prev, sector_id: e.target.value }))}
                  ...
                  <TableRow key={game.id}>
                    ...
                    <TableCell>
                      <Switch
                        ...
                        onCheckedChange={(checked) => handleToggleGameStatus(game.id, checked)}
                      />
                    </TableCell>
                    <TableCell>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setQuestForm(prev => ({ ...prev, target_value: Number(e.target.value) }))}
                        min="1"
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setQuestForm(prev => ({ ...prev, reward_points: Number(e.target.value) }))}
                        min="1"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setQuestForm(prev => ({ ...prev, quest_date: e.target.value }))}
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setQuestForm(prev => ({ ...prev, reward_description: e.target.value }))}
                      placeholder="Описание награды"
                    />
                  </div>

                  <div className="flex gap-4">
                    <Button variant="outline" onClick={() => setIsCreateQuestOpen(false)}>
                      Отмена
                    </Button>
              ...
              <TableBody>
                {quests.map((quest) => (
                  <TableRow key={quest.id}>
                    ...
                    <TableCell>
                      <div>
                        <div className="font-medium">{quest.reward_points} очков</div>
                        {quest.reward_description && (
                          <div className="text-sm text-muted-foreground">{quest.reward_description}</div>
                        )}
                      </div>
                    </TableCell>
                    <TableCell>
