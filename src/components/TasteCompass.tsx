  ...
  return (
    <Card className="max-w-4xl mx-auto">
      <CardHeader className="text-center">
        ...
        <p className="text-muted-foreground">Explore different flavor profiles</p>
      </CardHeader>
          ...
          {sectors.map(sector => {
            ...
            return (
              ...
              >
                ...
                <span className="text-xs text-center opacity-80">{sector.description}</span>
              </Button>
            );
          })}
        </div>
        ...
        {progress === 100 && (
          <div className="text-center p-4 bg-primary/10 rounded-lg">
            ...
            <p className="text-muted-foreground mb-3">
              You've explored all flavor profiles. Book your exclusive experience now.
            </p>
