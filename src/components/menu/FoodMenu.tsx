...
export const FoodMenu: React.FC<FoodMenuProps> = ({ className }) => {
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      name: 'Салат Цезарь',
      price: 25000,
      description: 'Свежий салат с курицей, пармезаном, сухариками и соусом цезарь',
      category: 'salad',
    ...
    <div className={cn("w-full", className)}>
      ...
      {filteredItems.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">Нет блюд в этой категории</h3>
