...
import { ArrowRight, Map, QrCode, Trophy, Sparkles, MapPin, Users, Calendar, Gift } from "lucide-react";
...
const TasteAlleySection = () => {
  ...
  const questSteps = [
    {
      id: 1,
      title: "NFC Check-In",
      description: "Tap your NFC passport at the entrance to begin your journey",
    ...
    },
    {
      ...
      description: "Visit all 4 interactive sectors and complete their challenges",
    ...
    },
    {
      ...
      description: "Complete all sectors to unlock exclusive Chef's Table access",
  ...
  const features = [
    {
      title: "NFC Passport",
      description: "Smart tracking system that records your progress through each sector",
      icon: <QrCode className="h-6 w-6 text-sage-blue" />
    },
    {
      title: "Interactive AR",
      description: "Augmented reality experiences that bring the spice route to life",
    ...
    {
      title: "Chef's Table",
      description: "Exclusive access to private dining experience upon completion",
      icon: <Trophy className="h-6 w-6 text-gold-accent" />
    }
  ];

  return (
    <section id="taste-alley" aria-label="Taste Alley interactive experience" className="py-20 bg-gradient-subtle">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16">
          {features.map((feature) => (
            <Card key={feature.title} className="group hover:shadow-elegant transition-all duration-300 bg-pure-white/90 backdrop-blur-sm border-cream-medium">
            ...
            <CardContent className="p-8">
              <div className="max-w-2xl mx-auto">
                ...
                <p className="text-cream-light mb-6 text-lg">
                  Master all 4 sectors to earn your place at our exclusive Chef's Table, 
                  complete with wine pairings and personalized tasting menu.
                </p>
