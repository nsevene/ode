...
const DatabaseAchievements = ({ onShare }: DatabaseAchievementsProps) => {
  ...
  const getAchievementIcon = (type: string) => {
    switch (type) {
      ...
      case 'epic': return <Trophy className="h-5 w-5" />;
        ...
        <Card className="bg-gradient-to-r from-emerald-50 to-teal-50 border-emerald-200">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                <div className="text-2xl font-bold text-emerald-600">{progress.total_score}</div>
                <div className="text-sm text-muted-foreground">Total Score</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-emerald-600">{progress.user_level}</div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <Badge variant="outline" className={getRarityBadge(achievement.achievement_type)}>
