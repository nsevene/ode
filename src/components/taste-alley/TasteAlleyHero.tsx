      ...
      <div className="text-center px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-charcoal/80 max-w-3xl mx-auto mb-8 leading-relaxed animate-fade-in">
            Embark on an immersive 51-meter journey through the world's most iconic flavors. 
            Four mystical sectors await: <span className="text-gold-accent font-semibold">Umami</span>, 
