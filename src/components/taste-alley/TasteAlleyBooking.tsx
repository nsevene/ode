    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h3 className="text-xl font-bold">Book Your Taste Alley Experience</h3>
          <Button 
            variant="outline" 
        ...
        <Card className="bg-gradient-to-r from-emerald-50 to-teal-50 border-emerald-200">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <h4 className="font-semibold text-emerald-800">{selectedPkg?.name}</h4>
                <p className="text-sm text-emerald-600">{selectedPkg?.description}</p>
              </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <ul className="text-sm text-amber-700 space-y-1">
                ...
                <li>• Experience runs every 30 minutes during operating hours</li>
                <li>• Suitable for ages 8+ (children must be accompanied by adults)</li>
