...
export const SEOHead: React.FC<SEOHeadProps> = ({
  ...
  const fullTitle = title.includes('ODE Food Hall') ? title : `${title} | ODE Food Hall`;
  const fullImage = image.startsWith('http') ? image : `https://odefoodhall.com${image}`;
  const fullUrl = url.startsWith('http') ? url : `https://odefoodhall.com${url}`;
