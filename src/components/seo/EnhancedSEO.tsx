...
export const seoData = {
  home: {
    title: "ODE Food Hall - Gastro Village Ubud | Authentic Culinary Experience",
    description: "Experience authentic Balinese cuisine at ODE Food Hall in Ubud. 8 taste sectors, local ingredients, and immersive culinary journey. Opening December 2025.",
    keywords: [
      "ODE Food Hall",
      "Ubud restaurant",
      "Balinese cuisine",
  ...
  tenants: {
    title: "Tenants Portal - Join ODE Food Hall | Culinary Business Opportunities",
    description: "Join ODE Food Hall as a tenant. Explore kitchen spaces, rates, and business opportunities in Ubud's premier food hall. Apply now.",
    keywords: [
      "tenant application",
      "kitchen rental",
      "food business",
  ...
  investors: {
    ...
    description: "Invest in ODE Food Hall, Ubud's premier gastro village. Access financial models, business plans, and investment opportunities.",
    keywords: [
  ...
  philosophy: {
    ...
    description: "Discover our philosophy of Tri Hita Karana - harmony with nature, spiritual world, and community at ODE Food Hall.",
    keywords: [
      "Tri Hita Karana",
      "Balinese philosophy",
      "harmony with nature",
...
export const useSEO = (page: keyof typeof seoData, customData?: Partial<SEOData>) => {
  ...
  return {
    ...
    structuredData: {
      ...
      "description": "Premier food hall in Ubud, Bali offering authentic culinary experiences",
      "address": {
        "@type": "PostalAddress",
