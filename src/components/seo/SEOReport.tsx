  ...
  useEffect(() => {
    const performSEOChecks = () => {
      ...
      results.push({
        ...
        status: description && description.length > 120 && description.length < 160 ? 'pass' : 'warning',
        message: description ? `Длина: ${description.length} символов` : 'Отсутствует',
        priority: 'high'
      });
      ...
      results.push({
        ...
        message: robots ? robots.getAttribute('content') || '' : 'Не установлен',
        priority: 'low'
      });
    ...
    <Card className="max-w-4xl mx-auto">
      ...
      <CardContent>
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg">
          <h3 className="font-semibold text-blue-900 mb-2">Рекомендации по улучшению:</h3>
