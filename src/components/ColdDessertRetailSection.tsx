        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="flex flex-col md:flex-row h-full">
                <div className="md:w-1/2 p-8 flex flex-col justify-center">
                  ...
                  <p className="text-charcoal/70 mb-6 leading-relaxed">
                    Cool down with our artisan gelato, fresh juices, and signature cold brews. 
                    Made with locally sourced ingredients and love.
                  </p>
                  <div className="space-y-3 mb-6">
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-golden rounded-full"></div>
                      <span className="text-sm text-charcoal/70">15+ artisan gelato flavors</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-golden rounded-full"></div>
                      <span className="text-sm text-charcoal/70">Fresh cold-pressed juices</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-golden rounded-full"></div>
                      <span className="text-sm text-charcoal/70">Specialty coffee & retail</span>
                    </div>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-charcoal">Popular Treats</h3>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <h4 className="font-medium text-charcoal">{dessert.name}</h4>
                        <p className="text-sm text-charcoal/70">{dessert.description}</p>
                        <Price value={dessert.price} className="text-sm font-semibold text-golden" />
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            <div className="bg-pure-white rounded-xl p-6 border border-golden/20">
              <h3 className="text-xl font-semibold text-charcoal mb-4">Take Home</h3>
              ...
              <Button variant="outline" size="sm" className="w-full mt-4 border-golden text-golden hover:bg-golden/10">
                Browse Retail
              </Button>
            </div>
          </div>
