...
export const OfflineMode: React.FC = () => {
  ...
  const generateMockData = (type: string) => {
    switch (type) {
      case 'menus':
        return [
          { id: 1, name: 'Taste Alley Menu', items: ['Nasi Goreng', 'Pad Thai', 'Ramen'] },
          { id: 2, name: 'Chef\'s Table Menu', items: ['Wagyu Steak', 'Lobster', 'Truffle Pasta'] }
        ];
      case 'events':
        return [
          { id: 1, name: 'Wine Tasting', date: '2024-02-15', available: true },
          { id: 2, name: 'Cooking Class', date: '2024-02-20', available: false }
        ];
      default:
        return [];
    }
        ...
        <CardContent>
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Загрузите данные для работы без интернета. Это включает меню, события, 
              информацию о локациях и ваши бронирования.
            </p>
