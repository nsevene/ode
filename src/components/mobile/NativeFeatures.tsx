      ...
      if (typeof window !== 'undefined' && (window as any).Capacitor) {
        ...
        try {
          ...
          const cleanup = () => {
            ...
            buttonContainer?.parentNode && buttonContainer.parentNode.removeChild(buttonContainer);
          };
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-3">
            <Button onClick={takePhoto} variant="outline" className="flex flex-col gap-2 h-auto py-4">
              <Camera className="h-6 w-6" />
              <span className="text-sm">Камера</span>
            </Button>
            
            <Button onClick={shareContent} variant="outline" className="flex flex-col gap-2 h-auto py-4">
              <Share2 className="h-6 w-6" />
              <span className="text-sm">Поделиться</span>
            </Button>
            
            <Button onClick={vibrateDevice} variant="outline" className="flex flex-col gap-2 h-auto py-4">
              <Vibrate className="h-6 w-6" />
              <span className="text-sm">Вибрация</span>
            </Button>
            
            <Button onClick={getLocation} variant="outline" className="flex flex-col gap-2 h-auto py-4">
              <MapPin className="h-6 w-6" />
              <span className="text-sm">Геолокация</span>
            </Button>
            
            <Button onClick={makeCall} variant="outline" className="flex flex-col gap-2 h-auto py-4 col-span-2">
