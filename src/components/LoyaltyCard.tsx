...
const LoyaltyCard = () => {
  const { loyaltyData, rewards, loading, redeemReward, getTierColor, getTierName } = useLoyalty();
    ...
    <Card className="bg-gradient-to-r from-primary/10 to-secondary/10">
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-3 gap-4 text-center">
          ...
          <div>
            <div className="text-2xl font-bold text-primary">{loyaltyData.visits}</div>
