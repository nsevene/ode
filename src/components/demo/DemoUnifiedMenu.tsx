...
const DemoUnifiedMenu = () => {
  ...
  const demoKitchens = [
    ...
    },
    {
      ...
      rating: 4.9,
      prepTime: "15-22 min",
      specialties: ["Truffle Carbonara", "Wood-fired Pizza", "Gelato Artigianale"],
      tags: ["Vegetarian", "Kids Menu", "Wine Pairing", "Artisan"],
      image: "/lovable-uploads/7183ec12-e263-49ad-bcf4-46b29c2e0c53.png",
      zone: "Ferment Sector",
      description: "Traditional Italian recipes with locally sourced ingredients"
    },
    {
      id: 3,
    ...
    },
    {
      ...
      tags: ["Vegan Options", "Healthy", "Organic", "Quick Service", "Gluten-Free"],
    ...
    },
    {
      ...
      rating: 4.9,
      prepTime: "5-10 min",
      specialties: ["Chocolate Lava Cake", "Tropical Sorbet", "Coffee Tiramisu"],
      tags: ["Desserts", "Coffee", "Sweet", "Artisan"],
      image: "/lovable-uploads/f41aad56-be6e-42c6-b101-46d8f2520a51.png",
      zone: "Sweet Corner",
      description: "Handcrafted desserts using Indonesian chocolate and tropical fruits"
    },
    {
      id: 10,
      ...
      zone: "Umami Sector",
      description: "Authentic Javanese home cooking passed down through generations"
    }
  ];

  const filterOptions = [
    "Vegan Options", "Vegetarian", "Gluten-Free", "Halal", 
    "Kids Menu", "Spicy", "Local", "Quick Service", "Healthy",
    "Traditional", "Artisan", "BBQ", "Street Food", "Desserts"
  ];
  ...
  const handleFilterToggle = (filter: string) => {
    ...
    track('menu_filter_toggle', { filter, action: selectedFilters.includes(filter) ? 'remove' : 'add' });
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold text-charcoal-dark mb-3">Unified Menu Experience</h2>
        <p className="text-charcoal-medium max-w-2xl mx-auto">
          Browse our curated selection of local kitchens. Each partner maintains their unique identity 
          while being part of our integrated ordering system.
        </p>
      </div>
            ...
            <CardContent className="p-0">
              ...
              <div className="p-4">
                <div className="flex items-start justify-between mb-2">
                  <div>
                    <h3 className="font-semibold text-charcoal-dark">{kitchen.name}</h3>
                    <p className="text-sm text-charcoal-medium">{kitchen.cuisine}</p>
                  </div>
      ...
      <div className="text-center bg-cream-light/50 rounded-lg p-6">
        ...
        <p className="text-sm text-charcoal-medium mb-4">
          In the real system: Real-time availability, live pricing, allergen warnings, 
          nutritional info, and integrated payment processing.
        </p>
