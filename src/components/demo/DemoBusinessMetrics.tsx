...
import { TrendingUp, Users, ShoppingCart, Star, Eye, Clock, MapPin } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold text-charcoal-dark mb-3">Business Metrics Dashboard</h2>
        <p className="text-charcoal-medium max-w-2xl mx-auto">
          Real-time analytics showing guest engagement, conversion rates, and revenue performance 
          across our food hall ecosystem.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        >
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold text-charcoal-dark">{currentMetrics.totalVisitors.toLocaleString()}</div>
            <div className="text-xs text-charcoal-medium">Total Visitors</div>
            <Badge variant="secondary" className="mt-1 text-xs">+12.4%</Badge>
          </CardContent>
        </Card>
        ...
        >
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold text-charcoal-dark">{currentMetrics.orderConversion}%</div>
            <div className="text-xs text-charcoal-medium">Order Conversion</div>
            <Badge variant="secondary" className="mt-1 text-xs">+5.2%</Badge>
          </CardContent>
        </Card>
        ...
        >
          <CardContent className="p-4 text-center">
            ...
            <Badge variant="secondary" className="mt-1 text-xs">+8.1%</Badge>
          </CardContent>
        </Card>
        ...
        >
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold text-charcoal-dark">{currentMetrics.tastePassportEngagement}%</div>
            <div className="text-xs text-charcoal-medium">Passport Engagement</div>
            <Badge variant="secondary" className="mt-1 text-xs">+15.3%</Badge>
          </CardContent>
        </Card>
        ...
        >
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold text-charcoal-dark">{currentMetrics.repeatCustomers}%</div>
            <div className="text-xs text-charcoal-medium">Repeat Customers</div>
            <Badge variant="secondary" className="mt-1 text-xs">+7.9%</Badge>
          </CardContent>
        </Card>
      ...
      <Card className="bg-pure-white/80 backdrop-blur">
        <CardContent className="p-6">
          <h3 className="text-lg font-semibold text-charcoal-dark mb-4">Zone Performance Analytics</h3>
            ...
            {zoneMetrics.map((zone) => (
              <div key={zone.zone} className="bg-cream-light/30 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-medium text-charcoal-dark text-sm">{zone.zone}</span>
                </div>
      ...
      <Card className="bg-pure-white/80 backdrop-blur">
        <CardContent className="p-6">
          <h3 className="text-lg font-semibold text-charcoal-dark mb-4">Revenue Streams Breakdown</h3>
          <div className="space-y-3">
            {revenueStreams.map((stream) => (
              <div key={stream.stream} className="flex items-center justify-between">
                <div className="flex items-center gap-3 flex-1">
                  <span className="text-sm font-medium text-charcoal-dark min-w-32">{stream.stream}</span>
                ...
                <div className="flex items-center gap-3">
                  <span className="text-sm text-charcoal-medium">{stream.percentage}%</span>
                  <span className="text-sm font-bold text-burgundy-primary min-w-20">{stream.amount}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="text-center bg-cream-light/50 rounded-lg p-6">
        <h4 className="font-semibold text-charcoal-dark mb-2">Real Analytics Integration</h4>
        <p className="text-sm text-charcoal-medium mb-4">
          Live data from POS systems, foot traffic sensors, mobile app analytics, 
          and guest feedback platforms provide comprehensive business intelligence.
        </p>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          ...
          <div>
            ...
            <div className="text-xs text-charcoal-medium">Integration Ready</div>
          </div>
        </div>
      </div>
    </div>
