...
import { Smartphone, Download, Wifi, Bell, Camera, MapPin, Star, X } from 'lucide-react';
  ...
  const pwaFeatures = [
    {
      ...
      description: 'Browse menus and view your Taste Passport even without internet',
    ...
    },
    {
      ...
      description: 'Scan QR codes for instant menu access and mission completion',
    ...
    },
    {
      ...
      description: 'Auto-detect your zone for location-based missions and offers',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold text-charcoal-dark mb-3">PWA Features Demo</h2>
        <p className="text-charcoal-medium max-w-2xl mx-auto">
          Experience our Progressive Web App capabilities. Install once, use everywhere - 
          with native-like features and offline functionality.
        </p>
      </div>
          ...
          <div className="text-center">
            {!isInstalled ? (
              <>
                ...
                <h3 className="text-xl font-semibold mb-2">Install Ode Food Hall App</h3>
                <p className="text-burgundy-light mb-4">
                  Get the full experience with app-like features, offline access, and push notifications.
                </p>
                <Button 
            ...
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h4 className="font-semibold text-charcoal-dark mb-2">{feature.title}</h4>
                  <p className="text-sm text-charcoal-medium mb-3">{feature.description}</p>
      ...
      <Card className="bg-pure-white/80 backdrop-blur border border-cream-medium">
        <CardContent className="p-6">
          <h4 className="font-semibold text-charcoal-dark mb-4 text-center">App Store Preview</h4>
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h5 className="font-semibold text-charcoal-dark">Ode Food Hall</h5>
              <p className="text-sm text-charcoal-medium mb-2">Gastro Village Ubud Experience</p>
              <div className="flex items-center gap-1 mb-2">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-4 h-4 fill-mustard-accent text-mustard-accent" />
                ))}
                <span className="text-sm text-charcoal-medium ml-1">4.9 • Food & Drink</span>
              </div>
              <div className="flex gap-2">
                <Badge variant="secondary" className="text-xs">Top Rated</Badge>
                <Badge variant="secondary" className="text-xs">Editor's Choice</Badge>
              </div>
            </div>
          </div>
          ...
          <Card className="w-full max-w-sm bg-pure-white">
            <CardContent className="p-6">
              <div className="flex justify-between items-start mb-4">
                <h4 className="font-semibold text-charcoal-dark">Add to Home Screen</h4>
                <Button
                  variant="ghost"
                  size="sm"
              ...
              <p className="text-sm text-charcoal-medium mb-4">
                Install the Ode Food Hall app for quick access to menus, ordering, and your Taste Passport.
              </p>
            ...
            <CardContent className="p-6">
              <div className="flex justify-between items-start mb-4">
                <h4 className="font-semibold text-charcoal-dark">
                  {pwaFeatures.find(f => f.id === showFeatureDemo)?.title} Demo
                </h4>
                <Button
                  variant="ghost"
                  size="sm"
      ...
      <div className="text-center bg-cream-light/50 rounded-lg p-6">
        <h4 className="font-semibold text-charcoal-dark mb-2">Complete PWA Experience</h4>
        <p className="text-sm text-charcoal-medium mb-4">
          Fast loading, offline functionality, push notifications, camera access, 
          location services, and native app-like experience across all devices.
        </p>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div>
            <div className="text-lg font-bold text-burgundy-primary">&lt; 3s</div>
          ...
          <div>
            <div className="text-lg font-bold text-burgundy-primary">Offline</div>
