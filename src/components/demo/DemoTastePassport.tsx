...
const DemoTastePassport = () => {
  ...
  const demoMissions = [
    {
      ...
      description: "Visit the Spice Sector and try a dish with 'Medium' or higher spice level",
      zone: "Spice Sector",
      reward: "Fire Walker Badge",
      points: 50,
      difficulty: "Easy",
      instructions: "Order any dish from Spicy Asia Corner with Medium+ spice level",
      completed: false
    },
    {
      ...
      points: 75,
      difficulty: "Medium",
      instructions: "Try kimchi, kombucha, or aged cheese from participating vendors",
      completed: false
    },
    {
      id: "secret-menu",
  ...
  const handleMissionComplete = (missionId: string) => {
    if (!completedMissions.includes(missionId)) {
      ...
      if (completedMissions.length >= 1) { // Will be 2 after this completion
        setTimeout(() => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold text-charcoal-dark mb-3">Taste Passport Demo</h2>
        <p className="text-charcoal-medium max-w-2xl mx-auto">
          Complete culinary missions across our taste zones to earn badges and unlock exclusive rewards. 
          This is a gamified dining experience that encourages exploration.
        </p>
      </div>
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-3 gap-4 mt-4">
              <div>
                ...
                <div className="text-sm text-burgundy-light">Missions Complete</div>
              </div>
              <div>
              ...
              <div>
                <div className="text-2xl font-bold">{collectedBadges.length}</div>
                <div className="text-sm text-burgundy-light">Badges Collected</div>
              </div>
            </div>
          ...
          return (
            ...
            >
              <CardContent className="p-4">
                ...
                <h4 className="font-semibold text-charcoal-dark mb-2">{mission.title}</h4>
                <p className="text-sm text-charcoal-medium mb-3">{mission.description}</p>
                ...
                <div className="bg-cream-light/50 rounded-lg p-3 mb-4">
                  <div className="text-xs font-medium text-charcoal-dark mb-1">Instructions:</div>
                  <div className="text-xs text-charcoal-medium">{mission.instructions}</div>
                </div>
      ...
      <div className="text-center bg-cream-light/50 rounded-lg p-6">
        <h4 className="font-semibold text-charcoal-dark mb-2">Real Implementation Features</h4>
        <p className="text-sm text-charcoal-medium mb-4">
          NFC tag scanning, GPS location verification, social sharing, loyalty integration, 
          seasonal missions, and exclusive partner rewards.
        </p>
