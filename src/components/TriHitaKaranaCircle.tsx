...
const TriHitaKaranaCircle: React.FC<TriHitaKaranaCircleProps> = ({ 
  ...
  const sectors = [
    { id: 'People', label: 'People', color: 'hsl(116, 25%, 43%)', start: 90, end: 210, textAngle: 150 },
    { id: 'Spirit', label: 'Spirit', color: 'hsl(45, 72%, 53%)', start: 210, end: 330, textAngle: 270 },
    { id: 'Nature', label: 'Nature', color: 'hsl(352, 55%, 34%)', start: 330, end: 450, textAngle: 30 }
  ];
    ...
    <div className={className}>
      ...
      >
        ...
        <text
          ...
          className="select-none font-display"
        >
          <tspan x={centerX} dy="0">Tri</tspan>
          <tspan x={centerX} dy={size * 0.045}>Hita</tspan>
          <tspan x={centerX} dy={size * 0.045}>Karana</tspan>
        </text>
      </svg>
    </div>
  );
