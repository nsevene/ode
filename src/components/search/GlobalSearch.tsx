...
const GlobalSearch: React.FC = () => {
    ...
    try {
      ...
      const mockResults: SearchResult[] = [
        ...
        },
        {
          ...
          type: 'vendor',
          title: 'Spicy Asia',
          description: 'Азиатская кухня с острыми блюдами и свежими ингредиентами',
        ...
        },
        {
          ...
          description: 'Научитесь готовить суши и роллы от профессионального шеф-повара',
          price: 3200,
  ...
  const handleResultClick = (result: SearchResult) => {
    ...
    switch (result.type) {
      case 'menu_item':
        navigate(`/vendors/${result.vendor_name?.toLowerCase().replace(' ', '-')}`);
        break;
      case 'vendor':
