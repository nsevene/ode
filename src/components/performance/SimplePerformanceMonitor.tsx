    ...
    const updateMetrics = () => {
      try {
        ...
        try {
          ...
          if (navigation && navigation.loadEventEnd > 0 && navigation.loadEventStart > 0) {
        ...
        try {
          if (performance.timeOrigin) {
            renderTime = Math.max(0, Math.min(10000, Math.round(performance.now() - performance.timeOrigin)));
          }
        } catch (e) {
          renderTime = 100;
        }
