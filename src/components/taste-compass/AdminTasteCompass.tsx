    ...
    const mockEvents: Event[] = [
      {
        ...
        isActive: true,
        participants: 156,
        rewards: ['Эксклюзивный зимний значок', 'Скидка 20% на горячие напитки']
      },
      {
        id: '2',
              ...
              <Card key={sector.id}>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-sm">
                      <span>Рейтинг:</span>
                      <span className="font-medium">{sector.averageRating}/5</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span>NFC тег:</span>
          ...
          {analytics && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="text-center">
                    <p className="text-2xl font-bold text-secondary">{analytics.activeUsers}</p>
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="text-center">
                    <p className="text-2xl font-bold text-accent">{analytics.totalVisits}</p>
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="text-center">
                    <p className="text-2xl font-bold text-orange-500">{analytics.averageRating}</p>
