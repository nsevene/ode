...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-20 bg-gradient-to-b from-pure-white to-cream-light/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6">
            {t("about.philosophy")} <span className="bg-gradient-to-r from-forest-green to-teal-dark bg-clip-text text-transparent">ODE</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {concepts.map((concept) => (
            <Card key={concept.title} className="group hover:shadow-medium transition-all duration-500 bg-pure-white border-cream-medium overflow-hidden">
        ...
        <div className="text-center bg-gradient-to-r from-sage-blue/20 to-cream-medium/30 rounded-2xl p-8 border border-cream-medium">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-forest-green hover:bg-forest-green/90 text-white">
