...
const TenantApplicationForm: React.FC<TenantApplicationFormProps> = ({ onSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const requiredFields = ['company_name', 'contact_person', 'email', 'phone', 'business_type', 'description'];
        ...
        <CardContent className="pt-6 text-center">
          <div className="mb-6">
            ...
            <p className="text-muted-foreground">
              Спасибо за интерес к ODE Food Hall. Наша команда рассмотрит вашу заявку 
              и свяжется с вами в течение 2-3 рабочих дней.
            </p>
          </div>
          <div className="space-y-3 text-sm">
            <p><strong>Номер заявки:</strong> #{Date.now().toString().slice(-6)}</p>
            <p><strong>Email для связи:</strong> {formData.email}</p>
          </div>
        </CardContent>
      </Card>
    );
  ...
  return (
    <Card className="max-w-4xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Заполните форму ниже, чтобы подать заявку на аренду помещения в ODE Food Hall
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <Label htmlFor="expected_revenue">Ожидаемый оборот в месяц</Label>
                <Select value={formData.expected_revenue} onValueChange={(value) => handleInputChange('expected_revenue', value)}>
                  <SelectTrigger>
              ...
              <div>
                ...
                <Select value={formData.investment_budget} onValueChange={(value) => handleInputChange('investment_budget', value)}>
                  <SelectTrigger>
                    <SelectValue placeholder="Выберите диапазон" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="under_1m">До 1,000,000 ₽</SelectItem>
                    <SelectItem value="1m_3m">1,000,000 - 3,000,000 ₽</SelectItem>
                    <SelectItem value="3m_5m">3,000,000 - 5,000,000 ₽</SelectItem>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <Select value={formData.floor_number.toString()} onValueChange={(value) => handleInputChange('floor_number', parseInt(value))}>
                  <SelectTrigger>
              ...
              <div>
                ...
                <Select value={formData.space_area.toString()} onValueChange={(value) => handleInputChange('space_area', parseInt(value))}>
                  <SelectTrigger>
              ...
              <div>
                <Label htmlFor="preferred_contact_method">Предпочитаемый способ связи</Label>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox 
                ...
                onCheckedChange={(checked) => handleInputChange('has_food_license', checked)}
              />
