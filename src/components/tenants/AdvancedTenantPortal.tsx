  ...
  const [tenants, setTenants] = useState<TenantData[]>([
    {
      ...
      documents: [
        { id: '1', name: 'Lease Agreement', type: 'contract', uploadDate: '2023-01-01', status: 'approved' },
        { id: '2', name: 'Insurance Certificate', type: 'insurance', uploadDate: '2023-01-15', status: 'approved' },
        { id: '3', name: 'Health Permit', type: 'permit', uploadDate: '2023-02-01', status: 'pending' }
      ],
      maintenanceRequests: [
        { id: '1', title: 'HVAC Repair', priority: 'medium', status: 'resolved', createdAt: '2024-01-15' },
        { id: '2', title: 'Lighting Issue', priority: 'low', status: 'open', createdAt: '2024-01-20' }
      ],
      payments: [
        { id: '1', amount: 15000, dueDate: '2024-01-01', paidDate: '2024-01-01', status: 'paid' },
    ...
    },
    {
      ...
      documents: [
        { id: '1', name: 'Lease Agreement', type: 'contract', uploadDate: '2023-03-01', status: 'approved' },
        { id: '2', name: 'Insurance Certificate', type: 'insurance', uploadDate: '2023-03-15', status: 'approved' }
      ],
      maintenanceRequests: [
        { id: '1', title: 'Plumbing Issue', priority: 'high', status: 'in_progress', createdAt: '2024-01-18' }
      ],
      payments: [
        { id: '1', amount: 12000, dueDate: '2024-01-01', paidDate: '2024-01-01', status: 'paid' },
          ...
          <CardContent className="pt-6">
            <div className="text-center">
              <p className="text-2xl font-bold text-orange-600">
                {tenants.reduce((sum, t) => sum + t.performance.revenue, 0).toLocaleString()} ₽
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    .map((tenant, index) => (
                      <div key={tenant.id} className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          <p className="font-medium">{tenant.performance.revenue.toLocaleString()} ₽</p>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {tenants
                    .flatMap(t => t.maintenanceRequests.filter(r => r.status !== 'resolved'))
                    .slice(0, 5)
                    .map((request) => (
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-medium">{tenant.monthlyRent.toLocaleString()} ₽/мес</p>
                    </div>
                    <div>
                      <p className="text-muted-foreground">Рейтинг</p>
                      <p className="font-medium">{tenant.performance.rating}/5</p>
                    </div>
                  </div>
            ...
            <CardContent>
              <div className="space-y-4">
                {tenants.flatMap(tenant => 
                  tenant.maintenanceRequests.map(request => ({ ...request, tenantName: tenant.name }))
                ).map((request) => (
        ...
        <TabsContent value="payments" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {tenants.flatMap(tenant => 
                  tenant.payments.map(payment => ({ ...payment, tenantName: tenant.name }))
                ).map((payment) => (
