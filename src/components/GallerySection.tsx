...
const GallerySection = () => {
  ...
  const prevImage = () => {
    setSelectedImage((prev) => (prev - 1 + renderImages.length) % renderImages.length);
  };

  return (
    <section id="gallery" className="py-20 bg-gradient-to-b from-cream/20 via-pure-white to-sage-blue/10">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-charcoal/80 max-w-2xl mx-auto">
            Современный дизайн с индустриальными элементами, бетонными поверхностями и живой зеленью
          </p>
        </div>
            ...
            <DialogContent className="max-w-5xl p-0">
              <div className="relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-charcoal/60 to-transparent p-6">
                  ...
                  <p className="text-cream-light/80">{renderImages[selectedImage].alt}</p>
