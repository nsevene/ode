  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-burgundy-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        ghost: "text-charcoal hover:bg-cream-light/50 hover:text-burgundy-primary",
        ...
        earth: "bg-gradient-to-r from-earth-warm to-terracotta text-pure-white shadow-elegant hover:shadow-strong hover:scale-[1.02]",
        glass: "bg-pure-white/40 backdrop-blur-md border border-pure-white/30 text-charcoal shadow-soft hover:bg-pure-white/60 hover:shadow-medium hover:scale-[1.02]",
        elegant: "bg-pure-white text-charcoal border border-cream-medium shadow-soft hover:bg-cream-light hover:shadow-medium",
        modern: "bg-teal-dark text-pure-white shadow-soft hover:bg-teal-dark/90 hover:shadow-medium hover:scale-[1.02]",
        accent: "bg-sage-blue text-pure-white shadow-soft hover:bg-sage-blue/90 hover:shadow-medium hover:scale-[1.02]",
        burgundy: "bg-burgundy text-pure-white shadow-elegant hover:bg-burgundy/90 hover:shadow-burgundy hover:scale-[1.02]",
      },
      size: {
