    ...
    <>
        ...
        <div className="relative z-10 text-center">
          <div className="bg-black/70 p-10 rounded-2xl inline-block backdrop-blur-sm">
            ...
            <p className="text-lg md:text-xl mb-2">
              📍 Ubud, Bali | Opening: December 1, 2025 | <strong>1,800 m²</strong>
            </p>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-15 px-6">
        <div className="bg-white rounded-2xl p-7 text-center shadow-sm hover:-translate-y-1.5 transition-transform duration-300">
          ...
          <Link to="/quick-booking" className="text-sm font-semibold text-burgundy-primary no-underline hover:underline">
            Book now →
          </Link>
        </div>
        <div className="bg-white rounded-2xl p-7 text-center shadow-sm hover:-translate-y-1.5 transition-transform duration-300">
          ...
          <Link to="/delivery-menu" className="text-sm font-semibold text-burgundy-primary no-underline hover:underline">
            Order →
          </Link>
        </div>
        <div className="bg-white rounded-2xl p-7 text-center shadow-sm hover:-translate-y-1.5 transition-transform duration-300">
          ...
          <Link to="/become-vendor" className="text-sm font-semibold text-burgundy-primary no-underline hover:underline">
            Apply →
          </Link>
        </div>
      </section>
