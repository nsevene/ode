...
const SpacesSection = () => {
  ...
  return (
    <section id="spaces" aria-label="Dining spaces and floor layouts" className="py-16 bg-pure-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-charcoal/70">{space.capacity}</p>
                      </div>
                    </div>
                    
                    <p className="text-sm text-charcoal/70 mb-4">{space.description}</p>
              ...
              {secondFloorSpaces.map((space, index) => (
                <Card key={index} className="group hover:shadow-soft transition-all duration-300 overflow-hidden">
                  <div className="aspect-[4/3] relative overflow-hidden">
                    ...
                    />
                    <div className="absolute top-4 left-4">
                      <Badge variant="secondary" className="bg-burgundy-primary text-pure-white">
                        Second Floor
                      </Badge>
                    </div>
                  </div>
        ...
        <div className="text-center mt-12">
          <Button asChild size="lg" className="bg-sage hover:bg-sage/90 text-pure-white">
            <Link to="/spaces">
              Explore All Spaces
            </Link>
          </Button>
