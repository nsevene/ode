          ...
          <div className="space-y-4">
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-medium text-green-800">Files Generated Successfully</span>
              </div>
              <p className="text-sm text-green-700">
                Upload these files to your website's root directory for better SEO.
              </p>
            </div>
            ...
            <div className="overflow-x-auto">
              <h4 className="font-medium mb-2">Pages in Sitemap ({pages.length}):</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                {pages.map((page) => (
                  <div key={page.url} className="flex justify-between p-2 bg-muted/50 rounded">
                    <span>{page.url}</span>
                    <span className="text-muted-foreground">Priority: {page.priority}</span>
                  </div>
                ))}
              </div>
            </div>
