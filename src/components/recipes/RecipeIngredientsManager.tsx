      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button variant="outline" size="sm" onClick={handleRecalculateNutrition}>
              Пересчитать
            </Button>
          </div>
        </CardHeader>
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4 text-sm text-muted-foreground">
                    ...
                    <span>
                      {Math.round((item.ingredient.calories_per_100g * item.quantity) / 100)} ккал
                    </span>
                    <span>
                      Б: {Math.round((item.ingredient.protein_per_100g * item.quantity) / 100)}г
                    </span>
                    <span>
                      Ж: {Math.round((item.ingredient.fat_per_100g * item.quantity) / 100)}г
                    </span>
                    <span>
                      У: {Math.round((item.ingredient.carbs_per_100g * item.quantity) / 100)}г
                    </span>
                  </div>
                </div>
                <Button
