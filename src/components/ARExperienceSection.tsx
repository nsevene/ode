...
const ARExperienceSection = () => {
    ...
    try {
      if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
        ...
        toast({
          ...
          description: "Point your camera at markers around the hall to discover hidden content.",
        });
  ...
  const arFeatures = [
    {
      ...
      description: "Scan QR codes to explore the historic spice trade routes in 3D"
    },
    {
      icon: <Camera className="h-5 w-5" />,
      title: "Interactive Markers",
      description: "Point your camera at sector markers for immersive storytelling"
    },
    {
  ...
  return (
    <section id="ar-experience" className="py-16 bg-gradient-to-b from-muted/20 to-background">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Immerse yourself in the spice route journey with cutting-edge AR technology
          </p>
        </header>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                {isARActive ? (
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground">AR Camera Active</p>
                  </div>
                ) : (
                  <div className="text-center">
                    ...
                    <h3 className="font-semibold mb-2">Scan with your phone camera</h3>
                    <p className="text-sm text-muted-foreground">Discover the spice route in 3D!</p>
                  </div>
                )}
              </div>
