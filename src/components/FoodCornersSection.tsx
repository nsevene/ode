...
const FoodCornersSection = () => {
  ...
  const tasteSectors = [
    {
      ...
      category: "ferment",
      description: "Living cultures and fermented flavors that restore connection to origins",
      specialties: ["Kombucha Lab", "Kimchi & Tempeh", "Fermented Sauces", "Living Cultures"],
    ...
    },
    {
      ...
      category: "smoke",
      description: "Ancient fire cooking uniting traditions from different continents",
      specialties: ["Neapolitan Pizza", "BBQ Station", "Smoked Meats", "Fire Cooking"],
    ...
    },
    {
      ...
      category: "spice",
      description: "Journey along the Great Silk Road through spices and seasonings",
      specialties: ["Indian Curries", "Thai Pastes", "Moroccan Blends", "Spice Route"],
    ...
    },
    {
      ...
      category: "umami",
      description: "The fifth taste - deep, rich, uniting ocean and earth treasures",
      specialties: ["Miso & Dashi", "Sushi Station", "Fermented Sauces", "Umami Bombs"],
    ...
    },
    {
      ...
      specialties: ["Salted Caramel", "Sea Salt Desserts", "Tropical Fruits + Chili", "Sweet-Savory Balance"],
    ...
    },
    {
      ...
      category: "zero-waste",
      description: "Philosophy of sustainability: from root to stem, from seed to fruit",
      specialties: ["Composting Demo", "Upcycled Ingredients", "Root-to-Stem Cooking", "Waste = Resource"],
    ...
    },
    {
      ...
      slogan: "Ode to Bali",
      category: "local",
      description: "Deep immersion in Balinese culture through authentic flavors",
      specialties: ["Balinese Dishes", "70%+ Local Ingredients", "Traditional Techniques", "Tri Hita Karana"],
    ...
    },
    {
      ...
      category: "sour-herb",
      description: "Living herb garden and sour notes creating refreshing balance",
      specialties: ["Fresh Herb Garden", "Botanical Cocktails", "Citrus & Herbs", "Garden-to-Glass"],
  ...
  const filteredSectors = activeFilter === "all" 
    ? tasteSectors 
    : tasteSectors.filter(sector => 
        sector.category === activeFilter
      );

  return (
    <section id="food-corners" className="py-20 bg-gradient-to-b from-cream/20 to-sage-blue/15">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6">
            Food <span className="bg-gradient-to-r from-burgundy to-terracotta bg-clip-text text-transparent">Corners</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredSectors.map((sector) => (
            <Card key={sector.id} className="group hover:shadow-[var(--shadow-tropical)] transition-all duration-500 bg-card border-gold-accent/20 overflow-hidden">
              <div className={`relative h-48 overflow-hidden ${sector.bgColor}`}>
                ...
                <div className="absolute top-2 right-2 bg-cream-light p-2 rounded-lg shadow-elegant hover:shadow-glow transition-all duration-300 border border-gold-accent/30">
                  ...
                  <div className="text-center mt-1">
                    <span className="text-xs text-charcoal font-medium">QR Menu</span>
                  </div>
                </div>
                
                <div className="absolute top-4 left-4">
                  <Badge variant="secondary" className="bg-cream-light/90 text-charcoal text-lg">
                    {sector.name}
                  </Badge>
                </div>
                <div className="absolute bottom-4 left-4 right-4">
                  <h3 className="text-xl font-bold text-cream-light mb-1">{sector.name}</h3>
                  <p className="text-cream-light/90 text-sm italic">"{sector.slogan}"</p>
                </div>
              </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {sector.specialties.map((specialty) => (
                      <Badge key={specialty} variant="outline" className="text-xs border-gold-accent/30">
                        {specialty}
                      </Badge>
                    ))}
                  </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {sector.experiences.map((experience) => (
                      <Badge key={experience} variant="secondary" className="text-xs bg-earth-warm/20 text-earth-warm">
                        {experience}
                      </Badge>
                    ))}
                  </div>
