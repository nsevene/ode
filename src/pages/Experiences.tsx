...
const Experiences = () => {
  ...
  const getMockExperiences = (): Experience[] => [
    {
      ...
      longDescription: 'Погрузитесь в уникальное гастрономическое путешествие через 8 цветных арок, каждая из которых представляет разные вкусовые секторы. Используйте NFC-паспорт для отслеживания прогресса и получения эксклюзивных скидок.',
    ...
    },
    {
      ...
      longDescription: 'Уникальная арт-инсталляция в виде винтажной лестницы, где каждая ступенька рассказывает историю вина. Проведите дегустацию 5 премиальных вин с сомелье в атмосфере искусства.',
      ...
      reviews: [
        {
          ...
          name: 'Алексей Иванов',
          rating: 5,
          comment: 'Потрясающая инсталляция и отличные вина. Сомелье очень знающий.',
    ...
    },
    {
      ...
      longDescription: 'Эксклюзивный кулинарный опыт с шеф-поваром в интимной обстановке. 6 блюд, каждое из которых рассказывает историю балийской кухни. Ограниченное количество мест для максимального внимания к каждому гостю.',
      ...
      requirements: ['Предварительное бронирование', 'Диетические ограничения за 48 часов'],
    ...
    },
    {
      ...
      longDescription: 'Расслабляющая атмосфера с премиальными кальянами и авторскими zero-proof коктейлями. Идеальное место для вечернего отдыха с друзьями в стильной обстановке.',
      ...
      reviews: [
        {
          ...
          name: 'Дмитрий Козлов',
          rating: 4,
          comment: 'Отличное место для отдыха. Кальяны качественные, коктейли вкусные.',
    ...
    },
    {
      ...
      longDescription: 'Ежедневные живые выступления местных и международных артистов в уютной атмосфере Taste Garden. Разнообразная программа от джаза до современной музыки.',
    ...
    },
    {
      ...
      longDescription: 'Интерактивный мастер-класс по приготовлению традиционных балийских блюд под руководством опытного шеф-повара. Изучите секреты местной кухни и приготовьте собственное блюдо.',
      ...
      reviews: [
        {
          ...
          name: 'Ольга Сидорова',
          rating: 5,
          comment: 'Потрясающий мастер-класс! Научилась готовить настоящий Nasi Goreng.',
  ...
  useEffect(() => {
    ...
    if (selectedDifficulty !== 'all') {
      filtered = filtered.filter(experience => experience.difficulty === selectedDifficulty);
    }
    ...
    if (selectedPriceRange !== 'all') {
      switch (selectedPriceRange) {
        case 'free':
          ...
          break;
        case 'low':
          filtered = filtered.filter(experience => experience.price > 0 && experience.price <= 200000);
          break;
        case 'medium':
          filtered = filtered.filter(experience => experience.price > 200000 && experience.price <= 500000);
          break;
        case 'high':
  ...
  }, [experiences, searchQuery, selectedCategory, selectedDifficulty, selectedPriceRange, sortBy]);
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          <Badge variant="outline" className={`text-xs ${getDifficultyColor(experience.difficulty)}`}>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <div className="text-right">
                          {experience.price === 0 ? (
                            <div className="font-semibold text-green-600">Бесплатно</div>
                          ) : (
                            <div className="font-semibold">{experience.price.toLocaleString()} ₽</div>
                          )}
                        </div>
                      </div>
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab}>
                ...
                <TabsContent value="overview" className="space-y-4">
                  <div className="text-center">
                    <selectedExperience.icon className={`h-12 w-12 mx-auto ${selectedExperience.color || 'text-primary'} mb-4`} />
                    <h3 className="font-semibold text-xl">{selectedExperience.title}</h3>
                    <p className="text-muted-foreground">{selectedExperience.longDescription}</p>
                  </div>
                  
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-3 bg-muted/50 rounded-lg">
                      <div className="text-2xl font-bold text-primary">{selectedExperience.duration}</div>
                      <div className="text-sm text-muted-foreground">Минут</div>
                    </div>
                    <div className="text-center p-3 bg-muted/50 rounded-lg">
                      <div className="text-2xl font-bold text-primary">{selectedExperience.capacity}</div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => setParticipants(Math.min(selectedExperience.capacity, participants + 1))}
                      >
                        <Plus className="h-4 w-4" />
                      </Button>
                    </div>
                    <p className="text-xs text-muted-foreground">Максимум: {selectedExperience.capacity} участников</p>
                  </div>
                  ...
                  <div className="bg-muted/50 p-4 rounded-lg">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="font-bold text-lg">
                        {selectedExperience.price === 0 ? 'Бесплатно' : `${(selectedExperience.price * participants).toLocaleString()} ₽`}
                      </span>
                    </div>
                    {selectedExperience.price > 0 && (
                      <div className="text-sm text-muted-foreground">
                        {selectedExperience.price.toLocaleString()} ₽ × {participants} участников
                      </div>
                    )}
                  </div>
