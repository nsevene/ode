  ...
  const benefits = [
    {
      ...
      description: "12-month contracts provide business stability and growth planning"
    },
    {
      icon: Shield,
      title: "Full Support",
      description: "Complete business support including operations, marketing, and management"
    },
    {
      icon: Star,
      title: "Prime Locations",
      description: "Best spots in the food hall with maximum visibility and foot traffic"
    },
    {
      icon: Award,
      ...
      <div className="container mx-auto px-4 pt-24 pb-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-charcoal/70 max-w-3xl mx-auto mb-8">
            Establish your culinary presence in ODE Food Hall with our long-term residency program. 
            Perfect for established restaurants and food businesses looking for a permanent home.
          </p>
                ...
                <CardHeader>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-charcoal/70">{pkg.size}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <DollarSign className="w-4 h-4 text-charcoal/60" />
                      <span className="text-sm text-charcoal/70">{pkg.price}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Calendar className="w-4 h-4 text-charcoal/60" />
                      <span className="text-sm text-charcoal/70">{pkg.duration}</span>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
        ...
        <section className="bg-gradient-light rounded-2xl p-8 text-center">
          ...
          <p className="text-charcoal/70 mb-6 max-w-2xl mx-auto">
            Join our long-term residency program and build your culinary legacy in ODE Food Hall.
          </p>
