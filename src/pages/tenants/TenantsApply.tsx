...
import { sendTenantApplicationConfirmation, sendTenantApplicationNotification } from '@/lib/email';
...
const TenantsApply = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await sendTenantApplicationConfirmation(formData.email, formData.fullName);
      ...
      toast({
        ...
        description: "Thank you for your interest in ODE Food Hall. We'll review your application and get back to you within 3 business days.",
      });
      ...
      <div className="container mx-auto px-4 pt-24 pb-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-charcoal/70 max-w-3xl mx-auto">
            Join ODE Food Hall and be part of Bali's premier culinary destination.
          </p>
      </div>
