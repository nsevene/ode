        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-6">
            ...
            <p className="text-sm text-yellow-700 mb-3">
              Your booking slot is temporarily reserved, but payment is required to confirm your reservation. 
              Please complete payment within 24 hours or your slot may be released.
            </p>
          </div>
