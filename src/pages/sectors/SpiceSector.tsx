...
const SpiceSector = () => {
  ...
  const spiceHeatLevels = [
    { level: "Mild", icon: "🌶️", description: "Gentle warmth, perfect for beginners" },
    { level: "Medium", icon: "🌶️🌶️", description: "Noticeable heat with great flavor" },
    { level: "Hot", icon: "🌶️🌶️🌶️", description: "Serious heat for spice lovers" },
    { level: "Extreme", icon: "🌶️🌶️🌶️🌶️", description: "Challenge level - proceed with caution!" }
  ];
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Ignite your senses with our fiery collection of the world's boldest and most flavorful spices
          </p>
        </div>
            ...
            <Card key={index} className="overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                ...
                <div className="flex gap-2 mb-4">
                  <Badge variant="secondary" className="bg-red-100 text-red-700">Spicy</Badge>
        ...
        <Card className="p-8 mb-12 bg-gradient-to-r from-red-50 to-orange-50">
          <h2 className="text-2xl font-bold mb-4 text-center">🔥 Spice Challenge 🔥</h2>
          <div className="text-center mb-6">
            <p className="text-muted-foreground">
              Think you can handle the heat? Take on our legendary spice challenge!
            </p>
          </div>
        ...
        <Card className="p-8 text-center bg-primary/5">
          <h2 className="text-2xl font-bold mb-4">Ready to Turn Up the Heat?</h2>
          <p className="text-muted-foreground mb-6">
            Explore our collection of the world's most exciting spices and flavors
          </p>
