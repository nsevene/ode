...
const KitchenDetail = () => {
  ...
  const fetchKitchenData = async () => {
    try {
      ...
      const mockKitchen = {
        id: 1,
        name: slug?.replace('-', ' ').replace(/^\w/, c => c.toUpperCase()) || 'Кухня',
        slug: slug,
        description: 'Описание кухни будет добавлено после создания базы данных',
        category: 'General',
  ...
  return (
    <div className="min-h-screen page" style={{ 
        ...
        <section>
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                {item.dietary_tags && item.dietary_tags.length > 0 && (
                  <div className="tags" style={{ display: 'flex', gap: '.4rem', marginBottom: '.5rem' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '.5rem' }}>
                    {cart[item.id] ? (
                      <div style={{ display: 'flex', alignItems: 'center', gap: '.5rem' }}>
                        <button
                          onClick={() => updateCartItem(item.id, cart[item.id] - 1)}
                          style={{
          ...
          {menuItems.length === 0 && (
            <div className="text-center py-12">
              <p style={{ color: 'hsl(var(--muted))' }}>No menu items available</p>
            </div>
          )}
        </section>
      </main>
      ...
      <KitchenCartBar 
        ...
        onCheckout={() => {
          ...
          toast.success(`Checkout: ${cartCount} items for $${cartTotal.toFixed(2)}`);
        }}
      />
    </div>
  );
