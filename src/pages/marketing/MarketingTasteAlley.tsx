  ...
  const strategies = [
    {
      ...
      description: "Position ODE Food Hall as Bali's premier culinary destination",
      icon: Target,
      features: ["Unique value proposition", "Brand differentiation", "Market positioning", "Competitive analysis"]
    },
    {
      title: "Content Marketing",
      description: "Create engaging content that showcases the food hall experience",
      icon: Camera,
      features: ["Social media content", "Blog posts", "Video content", "Photography"]
    },
    {
      title: "Digital Marketing",
      description: "Comprehensive digital marketing strategy across all channels",
      icon: BarChart3,
      features: ["SEO optimization", "Google Ads", "Social media ads", "Email marketing"]
    },
    {
      title: "Community Building",
      description: "Build a strong community around ODE Food Hall",
      icon: Users,
      features: ["Local partnerships", "Influencer collaborations", "Event marketing", "User-generated content"]
    }
  ];
        ...
        <div className="container mx-auto px-4 pt-24 pb-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-charcoal/70 max-w-3xl mx-auto">
              ...
              the Taste Alley experience that celebrates authentic flavors from around the world.
            </p>
          </div>
              ...
              {metrics.map((metric, index) => (
                <Card key={index} className="text-center">
                  <CardContent className="p-6">
                    ...
                    <div className="text-lg font-medium text-charcoal mb-1">{metric.title}</div>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-charcoal/70 mb-4">
                    Download logos, images, and brand guidelines for your marketing materials.
                  </p>
                  <Button variant="outline" className="w-full">
          ...
          <section className="bg-gradient-light rounded-2xl p-8 text-center">
            ...
            <p className="text-charcoal/70 mb-6 max-w-2xl mx-auto">
              Access our comprehensive marketing toolkit and start promoting ODE Food Hall today.
            </p>
