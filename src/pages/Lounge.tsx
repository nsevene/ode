...
import { Music, Sparkles, Users, Clock, Star, Mic, Wine, Calendar, Sunset, Coffee, ShoppingBag, Wifi, MapPin } from "lucide-react";
...
const Lounge = () => {
  ...
  const loungeFeatures = [
    {
      ...
      description: "World-class musicians, DJs, and performers every night of the week"
    },
    {
      icon: <Wine className="h-8 w-8 text-gold-accent" />,
      title: "Premium Bar",
      description: "Craft cocktails, premium spirits, and exclusive wine selections"
    },
    {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Second Floor Lounge | ODE Food Hall Ubud — Premium Nightlife Experience</title>
        <meta name="description" content="Elevate your evening at our premium lounge with live music, craft cocktails, and stunning jungle views. The ultimate nightlife destination in Ubud." />
      </Helmet>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto px-4">
          ...
          <p className="text-xl mb-12 max-w-4xl mx-auto leading-relaxed text-muted-foreground">
            Ascend to our exclusive second-floor lounge for an elevated evening experience. 
            Live music, craft cocktails, and breathtaking jungle views create the perfect atmosphere for unforgettable nights.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Weekly <span className="bg-gradient-to-r from-burgundy-primary to-gold-accent bg-clip-text text-transparent">Entertainment</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Every night brings a new experience with carefully curated entertainment and premium atmosphere.
            </p>
          </div>
                ...
                <CardContent className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
                    <div className="text-center md:text-left">
                      <h3 className="text-lg font-bold text-foreground">{event.day}</h3>
                      <p className="text-sm text-muted-foreground">{event.time}</p>
                    </div>
                    
                    <div className="md:col-span-2">
                      <h4 className="text-xl font-semibold text-foreground mb-1">{event.event}</h4>
                      <p className="text-muted-foreground">{event.artist}</p>
                    </div>
                    
                    <div className="text-center">
                      <Badge variant="outline" className="border-gold-accent/30">
                        {event.type}
                      </Badge>
                    </div>
                    
                    <div className="text-center md:text-right">
                      <div className="text-lg font-bold text-burgundy-primary mb-2">{event.cover}</div>
          ...
          <div className="bg-gradient-to-r from-burgundy-primary/10 to-purple-600/10 rounded-2xl p-8 border border-gold-accent/20">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Elevate your lounge experience with our exclusive VIP packages designed for special occasions.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="border-gold-accent/30 bg-card/50">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="text-2xl font-bold text-burgundy-primary mb-3">$200</div>
              ...
              <Card className="border-burgundy-primary bg-burgundy-primary/5 transform scale-105">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="text-2xl font-bold text-burgundy-primary mb-3">$400</div>
                  <ul className="text-sm text-muted-foreground space-y-2 mb-6">
              ...
              <Card className="border-gold-accent/30 bg-card/50">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="text-2xl font-bold text-burgundy-primary mb-3">Custom</div>
                  <ul className="text-sm text-muted-foreground space-y-2 mb-6">
      ...
      <section className="py-20 bg-gradient-to-b from-background to-muted/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Атмосферные <span className="bg-gradient-to-r from-burgundy-primary to-gold-accent bg-clip-text text-transparent">Зоны</span>
            </h2>
                ...
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <p className="text-lg text-emerald-700 dark:text-emerald-400 mb-6 italic">
                      "Ты просыпаешься не от кофе, а от дыхания. Каждое движение — как шаг внутрь себя."
                    </p>
                  ...
                  <div className="lg:text-right">
                    <div className="text-6xl lg:text-8xl opacity-20 font-bold text-emerald-600">07:00</div>
                    <p className="text-sm text-emerald-600 italic mt-4">
                      Птицы просыпаются вместе с тобой. Мир ещё не спешит — и ты тоже.
                    </p>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                  <div className="lg:order-2">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <Badge variant="outline" className="border-orange-300/50 text-orange-700">
                    ...
                    <p className="text-lg text-orange-700 dark:text-orange-400 mb-6 italic">
                      "Здесь не покупают. Здесь встречаются. Улыбаются. Пробуют. Общаются."
                    </p>
                    <div className="space-y-3 text-muted-foreground">
                      <div className="flex items-center gap-2">
                  ...
                  <div className="lg:order-1">
                    <div className="text-6xl lg:text-8xl opacity-20 font-bold text-orange-600">☀️</div>
                    <p className="text-sm text-orange-600 italic mt-4">
                      И уносят с собой не только авокадо, но и чувство — что был в настоящем.
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-8 lg:p-12">
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                  <div>
                    <div className="flex items-center gap-3 mb-4">
                      <div className="text-3xl">💻</div>
                      <Badge variant="outline" className="border-blue-300/50 text-blue-700">
                        Ежедневно
                      </Badge>
                    </div>
                    ...
                    <p className="text-lg text-blue-700 dark:text-blue-400 mb-6 italic">
                      "За окном листья. Внутри — прохлада. И ты. С ноутом, идеей и чашкой балийского кофе."
                    </p>
                    <div className="space-y-3 text-muted-foreground">
                      <div className="flex items-center gap-2">
                  ...
                  <div className="lg:text-right">
                    <div className="text-6xl lg:text-8xl opacity-20 font-bold text-blue-600">24/7</div>
              ...
              <CardContent className="p-8 lg:p-12">
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                  <div className="lg:order-2">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="text-3xl">🍷</div>
                      <Badge variant="outline" className="border-burgundy-300/50 text-burgundy-700">
                        Вечером
                      </Badge>
                    </div>
                    ...
                    <p className="text-lg text-burgundy-700 dark:text-burgundy-400 mb-6 italic">
                      "Кальян плавно тянется к тебе, вино охлаждается ровно до нужного градуса."
                    </p>
                    <div className="space-y-3 text-muted-foreground">
                      <div className="flex items-center gap-2">
                  ...
                  <div className="lg:order-1">
                    <div className="text-6xl lg:text-8xl opacity-20 font-bold text-burgundy-600">🌃</div>
                ...
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <p className="text-lg text-amber-700 dark:text-amber-400 mb-6 italic">
                      "Солнце медленно опускается за холмы. Ты не хочешь делать фото — ты просто хочешь запомнить."
                    </p>
                    <div className="space-y-3 text-muted-foreground">
                      <div className="flex items-center gap-2">
                  ...
                  <div className="lg:text-right">
                    <div className="text-6xl lg:text-8xl opacity-20 font-bold text-amber-600">🌅</div>
              ...
              <CardContent className="p-8 lg:p-12">
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                  <div className="lg:order-2">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="text-3xl">🍽</div>
                      <Badge variant="outline" className="border-violet-300/50 text-violet-700">
                        150 м²
                      </Badge>
                    </div>
                    ...
                    <p className="text-lg text-violet-700 dark:text-violet-400 mb-6 italic">
                      "Здесь можно собраться вшестером на винный сет. Или сделать pop-up на 50 человек."
                    </p>
                    <div className="space-y-3 text-muted-foreground">
                      <div className="flex items-center gap-2">
                  ...
                  <div className="lg:order-1">
                    <div className="text-6xl lg:text-8xl opacity-20 font-bold text-violet-600">∞</div>
          ...
          <div className="text-center mt-16">
            <Card className="bg-gradient-to-br from-burgundy-primary/5 to-gold-accent/5 border-gold-accent/20 inline-block">
              <CardContent className="p-8">
                <h3 className="text-2xl font-bold mb-4">Приходи за одним настроением</h3>
                <p className="text-muted-foreground mb-6 max-w-2xl">
                  Ты приходишь утром за дыханием. Остаёшься днём — поработать. 
                  Возвращаешься вечером — быть с кем-то. Или с собой.
                </p>
                <Button size="lg" className="bg-gradient-to-r from-burgundy-primary to-gold-accent">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-sm text-muted-foreground">Nights Per Week</div>
            </div>
            <div>
              <Mic className="h-8 w-8 text-burgundy-primary mx-auto mb-2" />
              <div className="text-2xl font-bold text-foreground">50+</div>
              <div className="text-sm text-muted-foreground">Live Performances</div>
            </div>
            <div>
      ...
      <section className="py-16 bg-gradient-to-r from-burgundy-primary/5 to-gold-accent/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Exclusive Member Benefits</h2>
            <p className="text-muted-foreground">Earn points, get rewards, and share the experience</p>
          </div>
