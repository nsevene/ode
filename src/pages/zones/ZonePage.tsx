...
const zoneData = {
  ferment: {
    ...
    emoji: '🧪',
    description: 'Исследуйте древние технологии ферментации и современную науку о пробиотиках',
    longDescription: 'Зона ферментации - это место, где традиции встречаются с инновациями. Здесь вы познакомитесь с древними техниками брожения, попробуете живые культуры и узнаете о пользе ферментированных продуктов для здоровья.',
    experiences: [
  ...
  smoke: {
    ...
    longDescription: 'Дымная зона раскрывает секреты копчения от техасского барбекю до азиатских техник горячего дыма. Здесь каждый кусок мяса, рыбы или овощей обретает уникальный аромат и вкус.',
    experiences: [
  ...
  spice: {
    title: 'Spice Sector',
    emoji: '🌶️',
    description: 'Путешествие по вкусовым традициям Азии через специи и пряности',
    longDescription: 'Острая зона - это калейдоскоп вкусов и ароматов. От мягких индийских карри до огненных тайских чили, здесь вы откроете для себя богатство азиатской кухни и науку о специях.',
    experiences: [
  ...
  umami: {
    title: 'Umami Sector',
    emoji: '🌊',
    description: 'Глубокое погружение в пятый вкус - умами и морские деликатесы',
    longDescription: 'Зона умами посвящена самому загадочному из пяти основных вкусов. Морские водоросли, выдержанные сыры, грибы и другие продукты раскроют секреты глубокого, насыщенного вкуса.',
    experiences: [
  ...
  'sweet-salt': {
    ...
    longDescription: 'Зона сладко-солёного вкуса исследует удивительные сочетания, которые создают кулинарную магию. От карамелизированного лука до солёной карамели - откройте секреты баланса.',
    experiences: [
  ...
  'sour-herb': {
    ...
    longDescription: 'Кисло-травяная зона посвящена свежести и яркости вкусов. Здесь вы узнаете о ферментации, маринадах, свежих травах и том, как кислинка может преобразить любое блюдо.',
    experiences: [
  ...
  'zero-waste': {
    ...
    longDescription: 'Зона безотходного производства показывает, как можно использовать каждую часть продукта. От овощных очисток до костного бульона - здесь каждый ингредиент имеет ценность.',
    experiences: [
...
export default function ZonePage() {
  ...
  return (
    <>
      <Helmet>
        <title>{data.title} | {BRAND_CANON}</title>
      ...
      <div className="min-h-screen bg-gradient-to-br from-background to-muted">
        {/* Hero Section */}
        <div className={`bg-gradient-to-br ${data.color} text-white relative overflow-hidden`}>
          ...
          <div className="relative container mx-auto px-6 py-16">
            ...
            <div className="max-w-4xl">
              ...
              <div className="mb-6">
                ...
                {data.venue.includes('2F') && data.venue.includes('Alcohol') && (
        ...
        <div className="container mx-auto px-6 py-12">
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              {/* CTA */}
              <Card className={`bg-gradient-to-br ${data.color} text-white border-none`}>
                <CardContent className="p-6">
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2">
                    {ZONES.filter(z => z !== zone).slice(0, 3).map((otherZone) => {
                      const otherData = zoneData[otherZone as keyof typeof zoneData];
                      return (
                        <Button
                          key={otherZone}
                          variant="ghost"
