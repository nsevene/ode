...
import { Phone, Mail, MessageCircle, Instagram, Facebook, Smartphone } from 'lucide-react';
  ...
  const faqItems = [
    {
      ...
      answer: "Сканируйте NFC-метки в каждом из 8 вкусовых секторов. После 4 сканов получаете скидку на Chef's Table, после 8 сканов — VIP-доступ и подарок."
    },
    {
      question: "Зоны и время доставки",
      answer: "Доставляем по Чангу, Семиньяку и Убуду. Время доставки: 30-60 минут. Breakfast for Villas доставляем к 08:00-09:00."
    },
    {
      question: "Как забронировать Chef's Table?",
      answer: "Бронирование через сайт или WhatsApp. 6-course ужин проходит с 17:00–19:30. Возможны винные и безалкогольные сеты."
    },
    {
      question: "Можно ли арендовать пространства?",
      answer: "Да! OdeGarden доступен для аренды в свободные часы. Taste Garden используется для мастер-классов и событий."
    },
    {
      question: "Есть ли вегетарианские опции?",
      answer: "В секторах Ferment и Sour-Herb полностью вегетарианское меню. Также доступны веганские опции в других секторах."
    }
  ];

  const socialLinks = [
    { name: "WhatsApp", icon: MessageCircle, href: "https://wa.me/6281943286395", color: "text-green-600" },
    { name: "Instagram", icon: Instagram, href: "https://instagram.com/odefoodhall", color: "text-pink-600" },
    { name: "Facebook", icon: Facebook, href: "https://facebook.com/odefoodhall", color: "text-blue-600" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-light">
      ...
      <main className={`${isMobile ? 'pb-20' : ''}`}>
          ...
          <div className="container mx-auto px-4">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium">selena@odefoodhall.com</p>
                      <p className="text-sm text-muted-foreground">Бронирование и события</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <Card className="mb-12">
              <CardHeader>
                ...
                <CardDescription>Следите за новостями и событиями</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <section className="py-12 bg-muted/30">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-8">Наши сервисы</h2>
