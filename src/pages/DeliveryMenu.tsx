      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Order authentic dishes from our eight culinary zones, delivered fresh to your location
          </p>
        </div>
            ...
            <Card key={item} className="border-sage/30">
              <CardHeader>
                ...
                <div className="flex gap-2">
                  <Badge variant="outline" className="border-sage text-sage">Zone Name</Badge>
                  <Badge variant="outline" className="border-terracotta text-terracotta">Vegan</Badge>
                </div>
              </CardHeader>
              <CardContent>
        ...
        <div className="fixed bottom-6 right-6">
          <Button size="lg" className="bg-golden hover:bg-golden/90 text-forest rounded-full shadow-lg">
