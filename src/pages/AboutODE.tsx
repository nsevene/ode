...
const AboutODE = () => {
  ...
  const timelineEvents = [
    {
      ...
      description: "Founded with a mission to celebrate authentic, sustainable cuisine in the heart of Ubud."
    },
    {
      year: "2024",
      title: "Community Building", 
      description: "Partnered with 50+ local farmers and artisans to create a truly sustainable food ecosystem."
    },
    {
      year: "2025",
      title: "Grand Opening",
      description: "Opening our doors to welcome food lovers from around the world to experience ODE."
    }
  ];
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1494790108755-2616b612b120?w=300&h=300&fit=crop&face"
    },
    {
      name: "James Wilson",
  ...
  const sustainabilityStats = [
    { icon: Leaf, number: "70%", label: "Local Ingredients", color: "text-sage" },
    { icon: Users, number: "150+", label: "Local Partners", color: "text-forest" },
    { icon: Heart, number: "Zero", label: "Food Waste Goal", color: "text-terracotta" },
    { icon: Globe, number: "100%", label: "Renewable Energy", color: "text-golden" }
  ];
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            A celebration of authentic flavors, sustainable practices, and the vibrant community 
            that makes Ubud a culinary destination like no other.
          </p>
        </div>
            ...
            {timelineEvents.map((event, index) => (
              <div key={index} className="flex items-start gap-8 mb-12 last:mb-0">
                ...
                <div className="flex-grow">
                  <h3 className="text-2xl font-bold text-forest mb-2">{event.title}</h3>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              <Card key={index} className="border-sage/30 text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-bold text-forest text-lg">{member.name}</h3>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We believe in nourishing both people and planet through responsible sourcing, 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {sustainabilityStats.map((stat, index) => (
              <Card key={index} className="border-sage/30 text-center hover:border-sage transition-colors">
        ...
        <Card className="bg-gradient-to-r from-forest to-sage text-white mb-16">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-xl mb-6">of our ingredients come from local Balinese farmers</p>
        ...
        <Card className="bg-gradient-to-r from-golden/20 to-terracotta/20 border-golden/30">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Be part of a movement that celebrates authentic flavors while supporting local communities 
