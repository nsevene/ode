          ...
          <div className="lg:col-span-2">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">Что вас ждет:</h4>
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">Что принести:</h4>
                  <ul className="list-disc list-inside text-gray-600 space-y-1">
              ...
              <CardContent className="space-y-4">
                <div className="text-center">
                  <div className="text-3xl font-bold text-gray-900 mb-2">
                    {event.price > 0 ? `${event.price.toFixed(0)} ₽` : 'Бесплатно'}
                  </div>
                  ...
                  <div className="space-y-3">
                    {!user ? (
                      <div className="text-center py-4">
                        ...
                        <p className="text-gray-600 mb-3">Войдите, чтобы забронировать</p>
                        <Button 
