...
const Breakfast = () => {
  const breakfastOptions = [
    ...
    },
    {
      ...
      time: "7:00 - 10:00",
      price: "From 200₽",
      features: ["Free delivery", "Hot food", "Fresh ingredients", "Custom orders"]
    }
  ];

  const menuItems = [
    { name: "Avocado Toast", price: "180₽", description: "Sourdough bread, avocado, cherry tomatoes" },
    { name: "Pancakes", price: "220₽", description: "Fluffy pancakes with maple syrup" },
    { name: "Eggs Benedict", price: "280₽", description: "Poached eggs, hollandaise sauce" },
    { name: "Smoothie Bowl", price: "190₽", description: "Acai bowl with fresh fruits" },
    { name: "Breakfast Burrito", price: "250₽", description: "Scrambled eggs, bacon, cheese" }
  ];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            Enjoy in our food hall or have it delivered to your villa.
          </p>
        </div>

        {/* Breakfast Options */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-center mb-12">Choose Your Breakfast Experience</h2>
        ...
        {/* Menu */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-center mb-12">Breakfast Menu</h2>
          ...
          <Card className="bg-gradient-to-r from-orange-500 to-yellow-500 text-white">
            <CardContent className="p-12">
              <div className="text-center">
                ...
                <h2 className="text-3xl font-bold mb-4">Villa Delivery Service</h2>
                <p className="text-xl mb-6 max-w-3xl mx-auto">
                  We deliver fresh breakfast directly to your villa. 
                  Perfect for a relaxing morning in your private space.
                </p>
