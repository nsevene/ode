...
const BookingDetail = () => {
  ...
  const downloadBookingPDF = () => {
    ...
    setTimeout(() => {
      ...
      element.href = 'data:text/plain;charset=utf-8,Booking Confirmation - ODE Food Hall';
      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        <Card className="max-w-md mx-auto">
          <CardContent className="text-center py-8">
            <h2 className="text-xl font-semibold mb-4">Бронирование не найдено</h2>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">ID: {booking.id.slice(-8).toUpperCase()}</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Информация о бронировании</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <div className="text-sm text-muted-foreground">Мероприятие</div>
                  <div className="font-medium">{formatExperienceType(booking.experience_type)}</div>
                </div>
                ...
                <div>
                  ...
                  <div className="font-medium">{booking.guest_count} человек</div>
                </div>
                ...
                {booking.special_requests && (
                  <div>
                    <div className="text-sm text-muted-foreground">Особые пожелания</div>
