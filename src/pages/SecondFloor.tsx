...
import { Clock, MapPin, Users, Calendar, Wifi, Coffee, Wine, Sunset, ShoppingBag, Sparkles, FlaskConical, Utensils, Laptop, Waves } from "lucide-react";
...
const SecondFloor = () => {
  ...
  const zones: Zone[] = [
    {
      ...
      description: "Lectures, shows, meetings, musical performances, dinners (17:00–19:30). The heart of the second floor where ideas come to life.",
      mood: "I'm part of something special happening here",
      features: ["Live performances", "Lecture space", "Musical shows", "Intimate dinners", "Transformable setup"],
    ...
    },
    {
      ...
      description: "The most relaxed zone. Evening, silence, mountains, sunset, wine — pure magic. Where time slows down and moments become memories.",
      mood: "I'm completely at peace, watching the world slow down",
      features: ["Mountain views", "Sunset views", "Wine selection", "Peaceful atmosphere", "Comfortable seating"],
    ...
    },
    {
      ...
      emoji: "💨",
      schedule: "Evening relaxation zone",
      description: "Evening relaxation zone with sofas, soft lighting, gentle ambient sounds. A place to unwind and connect.",
      mood: "I'm relaxing with friends, enjoying the calm vibe",
      features: ["Comfortable sofas", "Soft ambient lighting", "Hookah service", "Relaxed atmosphere", "Social seating"],
    ...
    },
    {
      ...
      description: "Comfortable workspace. Silence, power outlets, fresh air conditioning. Perfect for focused work or quiet meetings.",
      mood: "I'm productive and comfortable, everything I need is here",
      features: ["Air conditioning", "Power outlets", "Quiet environment", "WiFi", "Ergonomic seating"],
    ...
    },
    {
      ...
      description: "The emotional entrance to the second floor that leads directly to the tasting zone. Creates the first impression and sets the wine mood.",
      mood: "I'm ascending into a world of wine discovery",
      features: ["Wine display", "Tasting area", "Architectural feature", "Emotional entrance", "Wine education"],
  ...
  const getZoneColorClasses = (color: string, isSelected: boolean, isHovered: boolean) => {
    const colorMap = {
      emerald: {
  ...
  const getScheduleIcon = (schedule: string) => {
    ...
    if (schedule.includes("Transforms")) return <Sparkles className="w-4 h-4" />;
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Explore the atmospheric zones of ODE's second floor: Taste Garden, Sunset Terrace, Hookah Lounge, Coworking Zone, Wine Staircase. 700 m² of transformable space." />
      </Helmet>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-4xl mx-auto">
              700 m² of transformable space. Every hour — its own vibe. Every zone — its own mood.
            </p>
            <div className="text-lg text-muted-foreground">
              <div className="mb-2">🌿 Taste Garden (150 m²) | 🌇 Sunset Terrace (100 m²)</div>
              <div className="mb-2">💨 Hookah Lounge (90 m²) | 🧑‍💻 Coworking Zone (80 m²)</div>
          ...
          <div className="relative bg-card border border-border rounded-2xl p-8 mb-16">
            <h2 className="text-2xl font-bold text-center mb-8">Interactive Zone Map</h2>
            ...
            <div className="relative w-full h-96 bg-gradient-to-br from-muted/30 to-muted/10 rounded-xl border-2 border-dashed border-muted-foreground/20 overflow-hidden">
              ...
              {zones.map((zone) => {
                ...
                const colorClasses = getZoneColorClasses(zone.color, isSelected, isHovered);
                ...
                return (
                  ...
                  >
                    <div className={`w-12 h-12 rounded-full ${colorClasses.bg} ${colorClasses.border} border-2 flex items-center justify-center shadow-lg`}>
                    ...
                    <div className={`absolute top-14 left-1/2 transform -translate-x-1/2 whitespace-nowrap text-xs font-medium px-2 py-1 rounded ${colorClasses.bg} ${colorClasses.text} opacity-0 transition-opacity duration-200 ${
            ...
            <Card className="mb-16 animate-fade-in">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-sm text-muted-foreground">{selectedZone.schedule}</span>
                        {selectedZone.area && (
                  ...
                  <div className="flex gap-2">
                    <Badge variant={selectedZone.available ? "default" : "destructive"}>
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <p className="text-muted-foreground italic">"{selectedZone.description}"</p>
                </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {zones.map((zone) => {
              const colorClasses = getZoneColorClasses(zone.color, false, false);
                ...
                >
                  <CardHeader className="pb-3">
                    <div className="flex items-center gap-3">
                      <div className={`p-2 rounded-lg ${colorClasses.bg.replace('bg-', 'bg-').replace(/\d+/, '100')}`}>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <span className="text-sm text-muted-foreground">{zone.schedule}</span>
                        </div>
                        {zone.area && (
                      ...
                      <Badge variant={zone.available ? "default" : "destructive"} className="text-xs">
          ...
          <div className="mt-16 text-center">
            <Card className="bg-gradient-to-r from-primary/10 to-secondary/10 border-primary/20">
              <CardContent className="pt-6">
                <h3 className="text-2xl font-bold mb-4">Ready to Experience the Second Floor?</h3>
                <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                  Each zone offers a unique atmosphere designed for different moments of your day. 
                  From productive work sessions to magical sunset views.
                </p>
