    ...
    <div className="space-y-6">
      ...
      {showForm && (
        <Card>
          <CardHeader>
            <CardTitle>
              {isEditing ? 'Редактировать способ оплаты' : 'Добавить новую карту'}
            </CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="isDefault">Сделать способом оплаты по умолчанию</Label>
              </div>
                  ...
                  {method.expiryMonth && method.expiryYear && (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-gray-600">
                        Действует до: {formatExpiryDate(method.expiryMonth, method.expiryYear)}
                      </span>
                    </div>
                  )}
