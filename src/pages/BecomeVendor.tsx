...
const BecomeVendor = () => {
  ...
  const benefits = [
    ...
    { icon: Zap, title: "Premium Location", desc: "Heart of Ubud culinary scene" },
    { icon: DollarSign, title: "Revenue Support", desc: "Marketing & operational assistance" }
  ];

  const pricingPlans = [
    { name: "Corner Space", price: "$2,500", period: "/month", features: ["15m² space", "Equipment included", "Marketing support"] },
    { name: "Premium Corner", price: "$4,000", period: "/month", features: ["25m² space", "Premium location", "Full marketing package"] },
    { name: "Pop-Up Space", price: "$150", period: "/day", features: ["Flexible booking", "Equipment access", "Event promotion"] }
  ];
      ...
      <div className="min-h-screen bg-gradient-to-b from-forest-green/10 to-cream-light">
        <div className="container mx-auto px-4 py-8">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Join Bali's most innovative food hall. Showcase your culinary passion to thousands of food enthusiasts.
          </p>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              <Card key={index} className="border-sage/30 hover:border-sage transition-colors">
                <CardHeader className="text-center">
                  <CardTitle className="text-forest text-2xl">{plan.name}</CardTitle>
