...
import { Calendar, Clock, MapPin, Users, Mail, Phone, MessageSquare, ArrowLeft, CalendarCheck } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Просмотр ваших бронирований событий в ODE Food Hall" />
      </Helmet>
                ...
                <Card key={booking.id} className="overflow-hidden">
                  <CardHeader className="bg-muted/30">
                    <div className="flex justify-between items-start">
                      <CardTitle className="text-xl">{booking.experience_type}</CardTitle>
                  ...
                  <CardContent className="p-6">
                      ...
                      <div className="space-y-3">
                        ...
                        {booking.payment_amount && (
                          <div className="text-sm">
                            <span className="font-medium">Сумма:</span> ${(booking.payment_amount / 100).toFixed(2)}
                          </div>
                        )}
                      </div>
                    ...
                    <div className="mt-4 pt-4 border-t text-xs text-muted-foreground">
                      Забронировано: {format(new Date(booking.created_at), 'dd.MM.yyyy HH:mm', { locale: ru })}
                    </div>
                  </CardContent>
                </Card>
              ))}
