...
import { Calendar, Clock, MapPin, Users, DollarSign, Filter, ArrowLeft } from 'lucide-react';
        ...
        const mockEvents: Event[] = [
          {
            ...
            description: 'Explore the secrets of traditional Balinese cuisine with local chefs. Cook authentic dishes from fresh local ingredients.',
            ...
            category: 'cooking',
            image_url: '/lovable-uploads/c249dca9-bfb0-49e1-89cc-41abfb0c64ad.png'
          },
          {
            id: '2',
            title: 'Винная дегустация "Terroir"',
            description: 'Откройте для себя уникальные вина со всего мира в нашем винном погребе. Дегустация с сомелье и закусками.',
          ...
          },
          {
            ...
            description: 'Уютный семейный бранч с игровой зоной для детей, мини-мастер-классами и развлекательной программой.',
            ...
            category: 'family',
            image_url: '/lovable-uploads/f41aad56-be6e-42c6-b101-46d8f2520a51.png'
          },
          {
            id: '4',
            title: 'Джазовый вечер с коктейлями',
            description: 'Расслабьтесь под звуки живого джаза с авторскими коктейлями от наших барменов. Атмосферный вечер в стиле 1920-х.',
            ...
            image_url: '/lovable-uploads/d83cc98e-b461-4440-8991-869f626494cf.png'
          }
        ];
      ...
      const mockEvents: Event[] = [
        {
          id: '1',
          title: 'Мастер-класс по балийской кухне',
          description: 'Изучите секреты традиционной балийской кухни с местными шеф-поварами.',
          event_type: 'cooking_class',
          event_date: '2025-08-05',
          start_time: '18:00',
          end_time: '21:00',
          ...
          <div className="mb-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Присоединяйтесь к увлекательным кулинарным мастер-классам, винным дегустациям 
                и музыкальным вечерам в атмосфере тропических джунглей Убуда
              </p>
            </div>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {event.instructor && (
                      <div className="text-sm">
                        <span className="font-medium">Ведущий:</span> {event.instructor}
                      </div>
                    )}
                    ...
                    >
                      {event.available_spots === 0 ? 'Мест нет' : 'Забронировать'}
                    </Button>
                  </CardContent>
                </Card>
              ))}
