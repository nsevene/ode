...
Questions: ${formData.questions}`,
      ...
      toast({
        ...
        description: "Thank you for your interest in ODE Food Hall. We'll contact you within 24 hours to schedule your investment consultation.",
      });
        ...
        <div className="container mx-auto px-4 pt-24 pb-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-charcoal/70 max-w-3xl mx-auto">
              Book a personal consultation with our investment team to discuss ODE Food Hall 
              investment opportunities and learn more about our vision.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div>
                      ...
                      <Select value={formData.meetingType} onValueChange={(value) => handleInputChange('meetingType', value)}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="in-person">In-Person (Bali)</SelectItem>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <Label htmlFor="questions">Questions or Topics to Discuss</Label>
                    <Textarea
                      id="questions"
